...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private void setDataSource(FileDescriptor fileDescriptor, long j2, long j3) throws IOException {
    ...
    public MediaInfo getMediaInfo() {
        ...
        if (!TextUtils.isEmpty(str_getVideoCodecInfo)) {
            ...
            if (strArrSplit.length >= 2) {
                ...
                mediaInfo.mVideoDecoder = strArrSplit[0];
                mediaInfo.mVideoDecoderImpl = me.zhanghai.android.materialprogressbar.BuildConfig.FLAVOR;
            }
        }
        ...
        if (!TextUtils.isEmpty(str_getAudioCodecInfo)) {
            ...
            if (strArrSplit2.length >= 2) {
                ...
                mediaInfo.mAudioDecoder = strArrSplit2[0];
                mediaInfo.mAudioDecoderImpl = me.zhanghai.android.materialprogressbar.BuildConfig.FLAVOR;
            }
        }
        try {
