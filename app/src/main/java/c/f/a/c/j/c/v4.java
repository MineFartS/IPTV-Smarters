...
public enum v4 implements ra {
    ...
    private static final ua<v4> zzahh = new ua<v4>() { // from class: c.f.a.c.j.c.y4
    };
    ...
    public final String toString() {
        return "<" + v4.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + '>';
    }
