...
public enum w3 implements ra {
    ...
    private static final ua<w3> zzahh = new ua<w3>() { // from class: c.f.a.c.j.c.z3
    };
    ...
    public final String toString() {
        return "<" + w3.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + '>';
    }
