...
public class b {
    ...
    public static int A(@RecentlyNonNull Parcel parcel) {
        ...
        int iDataPosition = parcel.dataPosition();
        if (l(iS) != 20293) {
            String strValueOf = String.valueOf(Integer.toHexString(iS));
    ...
    public static void C(Parcel parcel, int i2, int i3, int i4) {
        if (i3 == i4) {
            return;
        }
    ...
    @RecentlyNonNull
    public static Integer v(@RecentlyNonNull Parcel parcel, int i2) {
        int iY = y(parcel, i2);
        if (iY == 0) {
            return null;
        }
