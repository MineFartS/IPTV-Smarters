...
public final class k4 {
    ...
    public final Bundle f14021b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public Bundle f14022c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final /* synthetic */ o4 f14023d;

    public k4(o4 o4Var, String str, Bundle bundle) {
        this.f14023d = o4Var;
        c.f.a.c.f.q.o.e("default_event_parameters");
        this.f14020a = "default_event_parameters";
        this.f14021b = new Bundle();
    }
    ...
    */
    public final android.os.Bundle a() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: c.f.a.c.k.b.k4.a():android.os.Bundle");
    }
    ...
    public final void b(Bundle bundle) {
        ...
        SharedPreferences.Editor editorEdit = this.f14023d.p().edit();
        if (bundle.size() == 0) {
            editorEdit.remove(this.f14020a);
        } else {
                ...
                if (obj != null) {
                    try {
                        ...
                        if (obj instanceof String) {
                            ...
                            this.f14023d.f14413a.c().o().b("Cannot serialize bundle value to SharedPreferences. Type", obj.getClass());
                        }
                        jSONObject.put("t", str);
                        jSONArray.put(jSONObject);
                    } catch (JSONException e2) {
                        this.f14023d.f14413a.c().o().b("Cannot serialize bundle value to SharedPreferences", e2);
                    }
                }
            }
