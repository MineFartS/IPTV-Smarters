...
public class c {
    ...
    public static void f(@RecentlyNonNull Parcel parcel, int i2, @RecentlyNonNull byte[] bArr, boolean z) {
        if (bArr == null) {
            if (z) {
                x(parcel, i2, 0);
            }
    ...
    public static void g(@RecentlyNonNull Parcel parcel, int i2, double d2) {
        x(parcel, i2, 8);
        parcel.writeDouble(d2);
    }

    public static void h(@RecentlyNonNull Parcel parcel, int i2, @RecentlyNonNull Double d2, boolean z) {
        if (d2 != null) {
            x(parcel, i2, 8);
    ...
    public static void i(@RecentlyNonNull Parcel parcel, int i2, float f2) {
        x(parcel, i2, 4);
        parcel.writeFloat(f2);
    }

    public static void j(@RecentlyNonNull Parcel parcel, int i2, @RecentlyNonNull Float f2, boolean z) {
        if (f2 != null) {
            x(parcel, i2, 4);
    ...
    public static void l(@RecentlyNonNull Parcel parcel, int i2, int i3) {
        x(parcel, i2, 4);
        parcel.writeInt(i3);
    }

    public static void m(@RecentlyNonNull Parcel parcel, int i2, @RecentlyNonNull int[] iArr, boolean z) {
        if (iArr == null) {
            if (z) {
                x(parcel, i2, 0);
            }
    ...
    public static void n(@RecentlyNonNull Parcel parcel, int i2, @RecentlyNonNull Integer num, boolean z) {
        if (num != null) {
            x(parcel, i2, 4);
    ...
    public static void o(@RecentlyNonNull Parcel parcel, int i2, long j2) {
        x(parcel, i2, 8);
        parcel.writeLong(j2);
    }

    public static void p(@RecentlyNonNull Parcel parcel, int i2, @RecentlyNonNull long[] jArr, boolean z) {
        if (jArr == null) {
            if (z) {
                x(parcel, i2, 0);
            }
