...
public enum g7 implements ra {
    ...
    private static final ua<g7> zzahh = new ua<g7>() { // from class: c.f.a.c.j.c.f7
    };
    ...
    public final String toString() {
        return "<" + g7.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + '>';
    }
