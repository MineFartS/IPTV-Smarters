...
public class b {
    ...
    public static final ThreadLocal<Matrix> f14733a = new ThreadLocal<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ThreadLocal<RectF> f14734b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f14733a;
        ...
        ThreadLocal<RectF> threadLocal2 = f14734b;
