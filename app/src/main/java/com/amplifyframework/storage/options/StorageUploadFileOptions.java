...
public class StorageUploadFileOptions extends StorageUploadOptions {
    ...
    public boolean equals(Object obj) {
        ...
        return d.a(getAccessLevel(), storageUploadFileOptions.getAccessLevel()) && d.a(getTargetIdentityId(), storageUploadFileOptions.getTargetIdentityId()) && d.a(getContentType(), storageUploadFileOptions.getContentType()) && d.a(getMetadata(), storageUploadFileOptions.getMetadata());
    }
