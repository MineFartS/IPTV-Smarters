...
public interface StorageService {
    ...
    URL getPresignedUrl(String str, int i2);

    List<StorageItem> listFiles(String str);
    ...
    TransferObserver uploadInputStream(String str, InputStream inputStream, ObjectMetadata objectMetadata);
}
