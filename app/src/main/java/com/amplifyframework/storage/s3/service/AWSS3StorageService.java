...
public final class AWSS3StorageService implements StorageService {
    ...
    public URL getPresignedUrl(String str, int i2) {
        return this.client.generatePresignedUrl(this.bucket, str, new Date(System.currentTimeMillis() + TimeUnit.SECONDS.toMillis(i2)));
    }

    @Override // com.amplifyframework.storage.s3.service.StorageService
    public List<StorageItem> listFiles(String str) {
    ...
    @Override // com.amplifyframework.storage.s3.service.StorageService
    public TransferObserver uploadInputStream(String str, InputStream inputStream, ObjectMetadata objectMetadata) {
        startServiceIfNotAlreadyStarted();
