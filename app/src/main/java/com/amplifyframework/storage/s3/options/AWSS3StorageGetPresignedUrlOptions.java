...
public final class AWSS3StorageGetPresignedUrlOptions extends StorageGetUrlOptions {
    ...
    public boolean equals(Object obj) {
        ...
        return d.a(getAccessLevel(), aWSS3StorageGetPresignedUrlOptions.getAccessLevel()) && d.a(getTargetIdentityId(), aWSS3StorageGetPresignedUrlOptions.getTargetIdentityId()) && d.a(Integer.valueOf(getExpires()), Integer.valueOf(aWSS3StorageGetPresignedUrlOptions.getExpires()));
    }

    @Override // com.amplifyframework.storage.options.StorageGetUrlOptions
    public int hashCode() {
        return d.b(getAccessLevel(), getTargetIdentityId(), Integer.valueOf(getExpires()));
    }
