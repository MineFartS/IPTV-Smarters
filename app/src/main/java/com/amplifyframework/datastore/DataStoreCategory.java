...
public final class DataStoreCategory extends Category<DataStorePlugin<?>> implements DataStoreCategoryBehavior {
    ...
    @Override // com.amplifyframework.datastore.DataStoreCategoryBehavior
    public <T extends Model> void observe(Class<T> cls, String str, Consumer<Cancelable> consumer, Consumer<DataStoreItemChange<T>> consumer2, Consumer<DataStoreException> consumer3, Action action) {
        getSelectedPlugin().observe(cls, str, consumer, consumer2, consumer3, action);
    }
