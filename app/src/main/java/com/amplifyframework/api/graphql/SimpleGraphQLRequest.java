...
public final class SimpleGraphQLRequest<R> extends GraphQLRequest<R> {
    ...
    public boolean equals(Object obj) {
        ...
        return d.a(this.document, simpleGraphQLRequest.document) && d.a(this.variables, simpleGraphQLRequest.variables);
    }
    ...
    @Override // com.amplifyframework.api.graphql.GraphQLRequest
    public int hashCode() {
        return d.b(Integer.valueOf(super.hashCode()), this.document, this.variables);
    }
}
