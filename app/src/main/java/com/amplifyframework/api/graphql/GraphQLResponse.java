...
public final class GraphQLResponse<R> {
    ...
    public static final class Error {
        ...
        public boolean equals(Object obj) {
            ...
            return d.a(this.message, error.message) && d.a(this.locations, error.locations) && d.a(this.path, error.path) && d.a(this.extensions, error.extensions);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (d.a(this.data, graphQLResponse.data)) {
            return d.a(this.errors, graphQLResponse.errors);
        }
        return false;
    }
