...
public final class RestOperationRequest {
    ...
    public boolean equals(Object obj) {
        ...
        if (d.a(getHttpMethod(), restOperationRequest.getHttpMethod()) && d.a(getPath(), restOperationRequest.getPath()) && d.a(getData(), restOperationRequest.getData()) && d.a(getHeaders(), restOperationRequest.getHeaders())) {
            return d.a(getQueryParameters(), restOperationRequest.getQueryParameters());
        }
        return false;
    }
