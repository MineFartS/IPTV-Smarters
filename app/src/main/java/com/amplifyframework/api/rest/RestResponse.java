...
public final class RestResponse {
    ...
    public static final class Code {
        ...
        public Code(int i2) {
            this.statusCode = validateValue(i2);
        }

        private int validateValue(int i2) {
            if (ALL_VALID_CODES.contains(Integer.valueOf(i2))) {
                return i2;
            }
            return -1;
        }
    ...
    public static final class Data {
        ...
        public boolean equals(Object obj) {
            ...
            return d.a(getRawBytes(), ((Data) obj).getRawBytes());
        }
    ...
    public RestResponse(int i2, Map<String, String> map) {
        this(i2, map, null);
    }

    public RestResponse(int i2, Map<String, String> map, byte[] bArr) {
        this.data = new Data(bArr);
        this.headers = map;
        this.code = new Code(i2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (d.a(getData(), restResponse.getData())) {
            return d.a(getCode(), restResponse.getCode());
        }
        return false;
    }
