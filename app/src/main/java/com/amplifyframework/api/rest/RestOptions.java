...
public final class RestOptions {
    ...
    public boolean equals(Object obj) {
        ...
        if (d.a(getPath(), restOptions.getPath()) && d.a(getData(), restOptions.getData()) && d.a(getHeaders(), restOptions.getHeaders())) {
            return d.a(getQueryParameters(), restOptions.getQueryParameters());
        }
        return false;
    }
