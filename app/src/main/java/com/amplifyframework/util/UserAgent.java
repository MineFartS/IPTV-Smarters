...
public final class UserAgent {
    ...
    private static String forAndroid() {
        return new Builder().libraryName(Platform.ANDROID.getLibraryName()).libraryVersion("1.24.0").systemName("Android").systemVersion(Build.VERSION.RELEASE).deviceManufacturer(Build.MANUFACTURER).deviceName(Build.MODEL).userLanguage(System.getProperty("user.language")).userRegion(System.getProperty("user.region")).toString();
    }
