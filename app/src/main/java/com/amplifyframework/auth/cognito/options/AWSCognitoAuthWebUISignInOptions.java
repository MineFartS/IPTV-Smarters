...
public final class AWSCognitoAuthWebUISignInOptions extends AuthWebUISignInOptions {
    ...
    public boolean equals(Object obj) {
        ...
        return d.a(getScopes(), aWSCognitoAuthWebUISignInOptions.getScopes()) && d.a(getSignInQueryParameters(), aWSCognitoAuthWebUISignInOptions.getSignInQueryParameters()) && d.a(getSignOutQueryParameters(), aWSCognitoAuthWebUISignInOptions.getSignOutQueryParameters()) && d.a(getTokenQueryParameters(), aWSCognitoAuthWebUISignInOptions.getTokenQueryParameters()) && d.a(getIdpIdentifier(), aWSCognitoAuthWebUISignInOptions.getIdpIdentifier()) && d.a(getFederationProviderName(), aWSCognitoAuthWebUISignInOptions.getFederationProviderName()) && d.a(getBrowserPackage(), aWSCognitoAuthWebUISignInOptions.getBrowserPackage());
    }
    ...
    @Override // com.amplifyframework.auth.options.AuthWebUISignInOptions
    public int hashCode() {
        return d.b(getScopes(), getSignInQueryParameters(), getSignOutQueryParameters(), getTokenQueryParameters(), getIdpIdentifier(), getFederationProviderName(), getBrowserPackage());
    }
