...
public final class AWSCognitoAuthSignUpOptions extends AuthSignUpOptions {
    ...
    public boolean equals(Object obj) {
        ...
        return d.a(getUserAttributes(), aWSCognitoAuthSignUpOptions.getUserAttributes()) && d.a(getValidationData(), aWSCognitoAuthSignUpOptions.getValidationData()) && d.a(getClientMetadata(), aWSCognitoAuthSignUpOptions.getClientMetadata());
    }
    ...
    @Override // com.amplifyframework.auth.options.AuthSignUpOptions
    public int hashCode() {
        return d.b(getUserAttributes(), getValidationData(), getClientMetadata());
    }
