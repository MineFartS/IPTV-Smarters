...
public final class AWSCognitoAuthPlugin extends AuthPlugin<AWSMobileClient> {
    ...
    public class AnonymousClass1 implements Callback<UserStateDetails> {
        ...
        /* JADX INFO: renamed from: lambda$null$0, reason: merged with bridge method [inline-methods] */
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: lambda$onResult$2, reason: merged with bridge method [inline-methods] */
        public /* synthetic */ void b(UserStateDetails userStateDetails) {
            ...
            if (i2 == 1 || i2 == 2) {
                ...
                if (i2 == 3) {
                    AWSCognitoAuthPlugin.this.fetchAndSetUserId(new Action() { // from class: c.b.a.a.a
                ...
                AWSCognitoAuthPlugin.this.fetchAndSetUserId(new Action() { // from class: c.b.a.a.b
                    @Override // com.amplifyframework.core.Action
                    public final void call() {
        ...
        public void onResult(UserStateDetails userStateDetails) {
            ...
            AWSCognitoAuthPlugin.this.awsMobileClient.addUserStateListener(new UserStateListener() { // from class: c.b.a.a.c
                ...
                public final void onUserStateChanged(UserStateDetails userStateDetails2) {
                    this.f5047a.b(userStateDetails2);
                }
            });
            this.val$latch.countDown();
        }
    ...
    /* JADX INFO: renamed from: com.amplifyframework.auth.cognito.AWSCognitoAuthPlugin$22, reason: invalid class name */
    public class AnonymousClass22 implements Callback<UserStateDetails> {
        ...
        public void onResult(final UserStateDetails userStateDetails) {
            ...
            aWSCognitoAuthPlugin.fetchAndSetUserId(new Action() { // from class: c.b.a.a.d
                @Override // com.amplifyframework.core.Action
                public final void call() {
                    Consumer consumer2 = consumer;
                    UserStateDetails userStateDetails2 = userStateDetails;
                    consumer2.accept(new AuthSignInResult(UserState.SIGNED_IN.equals(userStateDetails2.getUserState()), new AuthNextSignInStep(AuthSignInStep.DONE, userStateDetails2.getDetails(), null)));
                }
            });
        }
    }

    /* JADX INFO: renamed from: com.amplifyframework.auth.cognito.AWSCognitoAuthPlugin$24, reason: invalid class name */
    ...
    public class AnonymousClass5 implements Callback<SignInResult> {
        ...
        public void onResult(SignInResult signInResult) {
            try {
                ...
                AWSCognitoAuthPlugin aWSCognitoAuthPlugin = AWSCognitoAuthPlugin.this;
                final Consumer consumer = this.val$onSuccess;
                aWSCognitoAuthPlugin.fetchAndSetUserId(new Action() { // from class: c.b.a.a.e
                    @Override // com.amplifyframework.core.Action
                    public final void call() {
    ...
    public class AnonymousClass6 implements Callback<SignInResult> {
        ...
        public void onResult(SignInResult signInResult) {
            try {
                ...
                AWSCognitoAuthPlugin aWSCognitoAuthPlugin = AWSCognitoAuthPlugin.this;
                final Consumer consumer = this.val$onSuccess;
                aWSCognitoAuthPlugin.fetchAndSetUserId(new Action() { // from class: c.b.a.a.f
                    @Override // com.amplifyframework.core.Action
                    public final void call() {
                        consumer.accept(authSignInResultConvertSignInResult);
                    }
    ...
    public void signOutLocally(AuthSignOutOptions authSignOutOptions, final Action action, final Consumer<AuthException> consumer) {
        ...
        this.awsMobileClient.signOut(builderInvalidateTokens.build(), new Callback<Void>() { // from class: com.amplifyframework.auth.cognito.AWSCognitoAuthPlugin.21
            @Override // com.amazonaws.mobile.client.Callback
            public void onError(Exception exc) {
                Consumer consumer2;
                Throwable authException;
    ...
    public void signIn(String str, String str2, AuthSignInOptions authSignInOptions, Consumer<AuthSignInResult> consumer, Consumer<AuthException> consumer2) {
        ...
        if (authSignInOptions instanceof AWSCognitoAuthSignInOptions) {
            map.putAll(((AWSCognitoAuthSignInOptions) authSignInOptions).getMetadata());
        }
        this.awsMobileClient.signIn(str, str2, map, new AnonymousClass5(consumer, consumer2));
    }
    ...
    public void signInWithSocialWebUI(AuthProvider authProvider, Activity activity, AuthWebUISignInOptions authWebUISignInOptions, Consumer<AuthSignInResult> consumer, Consumer<AuthException> consumer2) {
        ...
        activity.getClass();
        authWebUISignInOptions.getClass();
        consumer.getClass();
        consumer2.getClass();
