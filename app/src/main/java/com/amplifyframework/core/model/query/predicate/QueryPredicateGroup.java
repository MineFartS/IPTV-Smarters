...
public final class QueryPredicateGroup implements QueryPredicate {
    ...
    public boolean equals(Object obj) {
        ...
        return d.a(type(), queryPredicateGroup.type()) && d.a(predicates(), queryPredicateGroup.predicates());
    }

    @Override // com.amplifyframework.core.model.query.predicate.Evaluable
    public boolean evaluate(Object obj) {
        int i2 = AnonymousClass1.$SwitchMap$com$amplifyframework$core$model$query$predicate$QueryPredicateGroup$Type[this.type.ordinal()];
        if (i2 == 1) {
