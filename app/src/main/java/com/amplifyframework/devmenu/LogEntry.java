...
public final class LogEntry implements Comparable<LogEntry> {
    ...
    public boolean equals(Object obj) {
        ...
        return this.date.equals(logEntry.getDate()) && d.a(this.namespace, logEntry.getNamespace()) && d.a(this.message, logEntry.getMessage()) && this.logLevel == logEntry.getLogLevel() && d.a(this.throwable, logEntry.getThrowable());
    }
    ...
    public String toString() {
        ...
        String stackTraceString = th == null ? BuildConfig.FLAVOR : Log.getStackTraceString(th);
