...
public class FraudServiceActivity extends c implements c.h.a.e.a.a {

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public Context f24706d;

    @BindView
    public TextView date;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public Thread f24707e = null;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            try {
                ...
                String strC = e.C(FraudServiceActivity.this.f24706d);
    ...
    public void k(ArrayList<c.h.a.e.e.a> arrayList) {
        if (arrayList == null || arrayList.size() <= 0) {
            ...
            b();
            this.recyclerView.setAdapter(new c.h.a.e.c.a(this.f24706d, arrayList));
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f24706d = this;
        Thread thread = this.f24707e;
        if (thread == null || !thread.isAlive()) {
            Thread thread2 = new Thread(new b());
            this.f24707e = thread2;
            thread2.start();
        }
        this.recyclerView.setLayoutManager(new GridLayoutManager(this, 2));
        new c.h.a.e.d.c(this, this.f24706d, "Fraud").a();
    }
    ...
    public void w(String str) {
        Toast.makeText(this.f24706d, BuildConfig.FLAVOR + str, 0).show();
        this.progress.setVisibility(8);
        this.recyclerView.setVisibility(0);
        this.tv_no_active_services.setVisibility(0);
    }
