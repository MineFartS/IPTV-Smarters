...
public class SuspendedServiceActivity extends c implements c.h.a.e.a.a {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            try {
                ...
                String strC = e.C(SuspendedServiceActivity.this.f24880d);
    ...
    public class b implements Runnable {
        ...
        public void run() {
            while (!Thread.currentThread().isInterrupted()) {
                try {
                    SuspendedServiceActivity.this.y0();
                    Thread.sleep(1000L);
    ...
    public void k(ArrayList<c.h.a.e.e.a> arrayList) {
        if (arrayList == null || arrayList.size() <= 0) {
            ...
            b();
            this.recyclerView.setAdapter(new c.h.a.e.c.a(this.f24880d, arrayList));
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f24880d = this;
        Thread thread = this.f24881e;
        if (thread == null || !thread.isAlive()) {
            Thread thread2 = new Thread(new b());
            this.f24881e = thread2;
            thread2.start();
        }
        this.recyclerView.setLayoutManager(new GridLayoutManager(this, 2));
        new c.h.a.e.d.c(this, this.f24880d, BucketVersioningConfiguration.SUSPENDED).a();
    }
    ...
    public void w(String str) {
        Toast.makeText(this.f24880d, BuildConfig.FLAVOR + str, 0).show();
        this.progress.setVisibility(8);
        this.recyclerView.setVisibility(0);
        this.tv_no_active_services.setVisibility(0);
    }
