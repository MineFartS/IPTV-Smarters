...
public class InvoiceRefundedActivity extends c implements b {
    ...
    public class a implements Runnable {
        ...
        /* JADX INFO: renamed from: com.nst.iptvsmarterstvbox.WHMCSClientapp.activities.InvoiceRefundedActivity$a$a, reason: collision with other inner class name */
        public class RunnableC0271a implements Runnable {
            ...
            public void run() {
                ...
                String strC = e.C(InvoiceRefundedActivity.this.f24735d);
        ...
        public final void a() {
            InvoiceRefundedActivity.this.runOnUiThread(new RunnableC0271a());
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        new d(this, this.f24735d, "Refunded").a();
    }
