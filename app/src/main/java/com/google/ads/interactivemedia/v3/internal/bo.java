...
public final class bo {
    ...
    private static WindowManager f21499b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String[] f21500c = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static float f21498a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static JSONObject b(int i2, int i3, int i4, int i5) {
        ...
        try {
            ...
            pn.h("Error with creating viewStateObject", e2);
        }
        return jSONObject;
    }
    ...
    public static void c(JSONObject jSONObject, String str) {
        try {
            ...
            pn.h("Error with setting ad session id", e2);
        }
    }
    ...
    public static void e(JSONObject jSONObject, bp bpVar) {
        az azVarA = bpVar.a();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> arrayListB = bpVar.b();
        int size = arrayListB.size();
        for (int i2 = 0; i2 < size; i2++) {
            jSONArray.put(arrayListB.get(i2));
        }
        try {
            jSONObject.put("isFriendlyObstructionFor", jSONArray);
            jSONObject.put("friendlyObstructionClass", azVarA.c());
            jSONObject.put("friendlyObstructionPurpose", azVarA.a());
            jSONObject.put("friendlyObstructionReason", azVarA.b());
        } catch (JSONException e2) {
            pn.h("Error with setting friendly obstruction", e2);
        }
    }
    ...
    public static void f(JSONObject jSONObject, String str) {
        try {
            ...
            pn.h("Error with setting not visible reason", e2);
        }
    }

    public static void g(Context context) {
        if (context != null) {
            f21498a = context.getResources().getDisplayMetrics().density;
            f21499b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    */
    public static void i(org.json.JSONObject r17) {
        /*
            r0 = r17
            ...
            r6 = 17
            if (r1 < r6) goto L2d
            android.view.WindowManager r1 = com.google.ads.interactivemedia.v3.internal.bo.f21499b
            if (r1 == 0) goto L67
            android.graphics.Point r1 = new android.graphics.Point
            r1.<init>(r4, r4)
            android.view.WindowManager r4 = com.google.ads.interactivemedia.v3.internal.bo.f21499b
        ...
        L67:
            r1 = 0
        L68:
            com.google.ads.interactivemedia.v3.internal.bn r4 = new com.google.ads.interactivemedia.v3.internal.bn
            r4.<init>(r5, r1)
            float r1 = r4.f21439a     // Catch: org.json.JSONException -> L7a
            double r5 = (double) r1     // Catch: org.json.JSONException -> L7a
            r0.put(r3, r5)     // Catch: org.json.JSONException -> L7a
            float r1 = r4.f21440b     // Catch: org.json.JSONException -> L7a
        ...
        L7a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.ads.interactivemedia.v3.internal.bo.i(org.json.JSONObject):void");
    }
    ...
    */
    public static boolean j(org.json.JSONObject r9, org.json.JSONObject r10) {
        ...
        L7:
            ...
            goto L94
        Le:
            java.lang.String[] r2 = com.google.ads.interactivemedia.v3.internal.bo.f21500c
            int r3 = r2.length
            r3 = 0
        L12:
            r4 = 4
        ...
        L94:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.ads.interactivemedia.v3.internal.bo.j(org.json.JSONObject, org.json.JSONObject):boolean");
    }
