...
public class PredefinedRetryPolicies {
    ...
    public static final class SDKDefaultBackoffStrategy implements RetryPolicy.BackoffStrategy {
        ...
        public final long delayBeforeNextRetry(AmazonWebServiceRequest amazonWebServiceRequest, AmazonClientException amazonClientException, int i2) {
            ...
            return this.random.nextInt(Math.min(this.maxDelayMs, (1 << i2) * this.baseDelayMs));
        }
    }
    ...
    public static RetryPolicy getDefaultRetryPolicyWithCustomMaxRetries(int i2) {
        return new RetryPolicy(DEFAULT_RETRY_CONDITION, DEFAULT_BACKOFF_STRATEGY, i2, false);
    }
    ...
    public static RetryPolicy getDynamoDBDefaultRetryPolicyWithCustomMaxRetries(int i2) {
        return new RetryPolicy(DEFAULT_RETRY_CONDITION, DEFAULT_BACKOFF_STRATEGY, i2, false);
    }
}
