...
public class InternalConfig {
    ...
    private static Map<String, HttpClientConfig> getDefaultHttpClients() {
        ...
        map.put("AmazonSimpleEmailServiceClient", new HttpClientConfig(ServiceAbbreviations.Email));
    ...
    private static Map<String, SignerConfig> getDefaultServiceSigners() {
        ...
        map.put(ServiceAbbreviations.Email, new SignerConfig("AWS4SignerType"));
