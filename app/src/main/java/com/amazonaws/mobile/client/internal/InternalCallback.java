...
public class InternalCallback<R> implements Callback<R> {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        public static final /* synthetic */ int[] $SwitchMap$com$amazonaws$mobile$client$internal$InternalCallback$Mode;
    ...
    public void call(R r, Exception exc) {
        int i2 = AnonymousClass2.$SwitchMap$com$amazonaws$mobile$client$internal$InternalCallback$Mode[this.mode.ordinal()];
        if (i2 == 1 || i2 == 2) {
            if (exc == null) {
