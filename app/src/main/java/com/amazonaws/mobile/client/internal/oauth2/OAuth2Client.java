...
public class OAuth2Client {
    ...
    public Callback<AuthorizeResponse> mAuthorizeCallback;
    private boolean mAuthorizeOrSignOutRedirectReceived;
    private String mClientId;
    public final Context mContext;
    public c mCustomTabsClient;
    public final e mCustomTabsServiceConnection;
    public f mCustomTabsSession;
    ...
    public b mCustomTabsCallback = new b() { // from class: com.amazonaws.mobile.client.internal.oauth2.OAuth2Client.1
        @Override // a.d.b.b
    ...
    public static /* synthetic */ class AnonymousClass3 {
        public static final /* synthetic */ int[] $SwitchMap$com$amazonaws$mobile$client$internal$oauth2$OAuth2Client$PKCEMode;
    ...
    public void authorize(Uri uri, Callback<AuthorizeResponse> callback) {
        ...
        try {
            ...
            int i2 = AnonymousClass3.$SwitchMap$com$amazonaws$mobile$client$internal$oauth2$OAuth2Client$PKCEMode[this.mPKCEMode.ordinal()];
            if (i2 == 1) {
