...
public class SplitBackgroundDrawable extends Drawable {
    ...
    public SplitBackgroundDrawable(int i2) {
        this.distanceFromTopToSplitPoint = -1;
        this.paint = new Paint();
        this.topBackgroundColor = -1;
        setSplitPointDistanceFromTop(i2);
    }
    ...
    public void setSplitPointDistanceFromTop(int i2) {
        this.distanceFromTopToSplitPoint = i2;
        invalidateSelf();
    }
}
