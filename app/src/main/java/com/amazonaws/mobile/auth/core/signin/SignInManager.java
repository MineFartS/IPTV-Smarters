...
public class SignInManager {
    ...
    public boolean handleActivityResult(int i2, int i3, Intent intent) {
        for (SignInProvider signInProvider : this.signInProviders.values()) {
            if (signInProvider.isRequestCodeOurs(i2)) {
    ...
    public void handleRequestPermissionsResult(int i2, String[] strArr, int[] iArr) {
        SignInPermissionsHandler signInPermissionsHandler = this.providersHandlingPermissions.get(i2);
        if (signInPermissionsHandler != null) {
            signInPermissionsHandler.handleRequestPermissionsResult(i2, strArr, iArr);
        }
    }
