...
public class CognitoUser {
    ...
    public static class AuthenticationHelper {
        ...
        public byte[] getPasswordAuthenticationKey(String str, String str2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            BigInteger bigIntegerMod = bigInteger.subtract(bigInteger5.multiply(bigInteger6.modPow(bigInteger4, bigInteger7))).modPow(this.f18882a.add(bigInteger3.multiply(bigInteger4)), bigInteger7).mod(bigInteger7);
            try {
    ...
    private ConfirmDeviceResult confirmDevice(NewDeviceMetadataType newDeviceMetadataType) {
        ...
        try {
            ...
            LOGGER.error("Device confirmation failed: ", e2);
            return null;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public ListDevicesResult listDevicesInternal(CognitoUserSession cognitoUserSession, int i2, String str) {
        if (cognitoUserSession == null || !cognitoUserSession.isValid()) {
            throw new CognitoNotAuthorizedException("User is not authorized");
        }
    ...
    private CognitoUserSession readCachedTokens() {
        ...
        try {
            ...
            LOGGER.error("Error while reading the tokens from the persistent store.", e2);
            ...
            public void run() {
                ...
                try {
                    ...
                    if (!CognitoServiceConstants.CHLG_TYPE_USER_PASSWORD_VERIFIER.equals(initiateAuthResultInitiateAuth.getChallengeName())) {
                        runnableHandleChallenge = CognitoUser.this.handleChallenge((Map<String, String>) map, initiateAuthResultInitiateAuth, authenticationDetails, authenticationHandler, z);
                    } else {
    ...
    public Runnable _initiateUserAuthentication(Map<String, String> map, final AuthenticationDetails authenticationDetails, final AuthenticationHandler authenticationHandler, boolean z) {
        return CognitoServiceConstants.CHLG_TYPE_USER_PASSWORD_VERIFIER.equals(authenticationDetails.getAuthenticationType()) ? startWithUserSrpAuth(map, authenticationDetails, authenticationHandler, z) : CognitoServiceConstants.CHLG_TYPE_CUSTOM_CHALLENGE.equals(authenticationDetails.getAuthenticationType()) ? startWithCustomAuth(map, authenticationDetails, authenticationHandler, z) : CognitoServiceConstants.CHLG_TYPE_USER_PASSWORD.equals(authenticationDetails.getAuthenticationType()) ? startWithUserPasswordAuth(map, authenticationDetails, authenticationHandler, z) : new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.8
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void associateSoftwareToken(String str, RegisterMfaHandler registerMfaHandler) {
        ...
        try {
            ...
            registerMfaHandler.onFailure(e2);
        }
    }
    ...
    public void getAttributeVerificationCode(Map<String, String> map, String str, VerificationHandler verificationHandler) {
        ...
        try {
            ...
            verificationHandler.onFailure(e2);
        }
    }
    ...
    public void listDevices(int i2, String str, DevicesHandler devicesHandler) {
        if (devicesHandler == null) {
            throw new CognitoParameterInvalidException("callback is null");
        }
        try {
            ListDevicesResult listDevicesResultListDevicesInternal = listDevicesInternal(getCachedSession(), i2, str);
    ...
    public void listDevicesInBackground(final int i2, final String str, final DevicesHandler devicesHandler) {
        if (devicesHandler == null) {
            throw new CognitoParameterInvalidException("callback is null");
        }
        new Thread(new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.40
            ...
            public void run() {
                ...
                Handler handler = new Handler(CognitoUser.this.context.getMainLooper());
                try {
                    ListDevicesResult listDevicesResultListDevicesInternal = CognitoUser.this.listDevicesInternal(this.getCachedSession(), i2, str);
    ...
    public void updateAttributes(CognitoUserAttributes cognitoUserAttributes, Map<String, String> map, UpdateAttributesHandler updateAttributesHandler) {
        ...
        try {
            ...
            updateAttributesHandler.onFailure(e2);
        }
    }
