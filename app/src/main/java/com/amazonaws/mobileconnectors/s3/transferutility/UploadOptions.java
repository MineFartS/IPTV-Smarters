...
public final class UploadOptions {
    ...
    public boolean equals(Object obj) {
        ...
        return d.a(this.bucket, uploadOptions.bucket) && d.a(this.metadata, uploadOptions.metadata) && this.cannedAcl == uploadOptions.cannedAcl && d.a(this.listener, uploadOptions.listener);
    }
    ...
    public int hashCode() {
        return d.b(this.bucket, this.metadata, this.cannedAcl, this.listener);
    }
