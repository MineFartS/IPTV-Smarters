...
public class SimpleTypeJsonUnmarshallers {
    ...
    public static class DateJsonUnmarshaller implements Unmarshaller<Date, JsonUnmarshallerContext> {
        ...
        public Date unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) {
            ...
            try {
                int i2 = AnonymousClass1.$SwitchMap$com$amazonaws$transform$TimestampFormat[this.format.ordinal()];
                return i2 != 1 ? i2 != 2 ? new Date(NumberFormat.getInstance(new Locale("en")).parse(strNextString).longValue() * 1000) : DateUtils.parseRFC822Date(strNextString) : DateUtils.parseISO8601Date(strNextString);
