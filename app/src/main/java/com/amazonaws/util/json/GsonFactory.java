...
public final class GsonFactory implements AwsJsonFactory {
    ...
    public static final class GsonReader implements AwsJsonReader {
        ...
        public boolean isContainer() throws IOException {
            b bVarB0 = this.reader.B0();
            return b.BEGIN_ARRAY.equals(bVarB0) || b.BEGIN_OBJECT.equals(bVarB0);
        }

        @Override // com.amazonaws.util.json.AwsJsonReader
        public String nextName() {
            return this.reader.U();
        }

        @Override // com.amazonaws.util.json.AwsJsonReader
        public String nextString() throws IOException {
            b bVarB0 = this.reader.B0();
            if (!b.NULL.equals(bVarB0)) {
                return b.BOOLEAN.equals(bVarB0) ? this.reader.w() ? "true" : "false" : this.reader.w0();
            }
            this.reader.c0();
            return null;
        }
        ...
        public AwsJsonToken peek() {
            try {
                return GsonFactory.convert(this.reader.B0());
    ...
    public static final class GsonWriter implements AwsJsonWriter {
        ...
        public AwsJsonWriter value(ByteBuffer byteBuffer) throws IOException {
            ...
            byteBuffer.reset();
            this.writer.E0(BinaryUtils.toBase64(bArr));
            return this;
        }

        @Override // com.amazonaws.util.json.AwsJsonWriter
        public AwsJsonWriter value(Date date) throws IOException {
            this.writer.D0(BigDecimal.valueOf(date.getTime()).scaleByPowerOfTen(NEGATIVE_THREE));
            return this;
        }
