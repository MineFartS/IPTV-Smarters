...
public class AccountTakeoverActionsTypeJsonMarshaller {
    ...
    public void marshall(AccountTakeoverActionsType accountTakeoverActionsType, AwsJsonWriter awsJsonWriter) {
