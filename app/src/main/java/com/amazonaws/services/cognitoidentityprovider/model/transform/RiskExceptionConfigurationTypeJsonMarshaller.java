...
public class RiskExceptionConfigurationTypeJsonMarshaller {
    ...
    public void marshall(RiskExceptionConfigurationType riskExceptionConfigurationType, AwsJsonWriter awsJsonWriter) {
