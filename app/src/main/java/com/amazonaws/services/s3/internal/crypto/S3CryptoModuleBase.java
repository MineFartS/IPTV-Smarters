...
public abstract class S3CryptoModuleBase<T extends MultipartUploadCryptoContext> extends S3CryptoModule<T> {
    ...
    public final CryptoConfiguration cryptoConfig;
    public final S3CryptoScheme cryptoScheme;
    public final EncryptionMaterialsProvider kekMaterialsProvider;
    public final AWSKMSClient kms;
    public final Log log = LogFactory.getLog(getClass());
    public final Map<String, T> multipartUploadContexts = Collections.synchronizedMap(new HashMap());
    public final S3Direct s3;
    ...
    private static long getCipherBlockLowerBound(long j2) {
        long j3 = (j2 - (j2 % 16)) - 16;
        if (j3 < 0) {
            return 0L;
        }
    ...
    private static long getCipherBlockUpperBound(long j2) {
    ...
    private CipherLiteInputStream newS3CipherLiteInputStream(AbstractPutObjectRequest abstractPutObjectRequest, ContentCryptoMaterial contentCryptoMaterial, long j2) {
        ...
        try {
            ...
            if (j2 > -1) {
                resettableInputStream = new LengthCheckInputStream(resettableInputStream, j2, false);
            }
    ...
    private PutObjectResult putObjectUsingInstructionFile(PutObjectRequest putObjectRequest) {
        ...
        PutObjectRequest putObjectRequestWithInputStream = putObjectRequest.mo0clone().withFile((File) null).withInputStream((InputStream) null);
    ...
    public abstract long ciphertextLength(long j2);
    ...
    public final PutObjectRequest createInstructionPutRequest(String str, String str2, ContentCryptoMaterial contentCryptoMaterial) {
        ...
        objectMetadata.addUserMetadata(Headers.CRYPTO_INSTRUCTION_FILE, BuildConfig.FLAVOR);
    ...
    public final SecretKey generateCEK(EncryptionMaterials encryptionMaterials, Provider provider) {
        ...
        try {
            ...
            if (keyPair == null || this.cryptoScheme.getKeyWrapScheme().getKeyWrapAlgorithm(keyPair.getPublic(), provider) != null) {
                ...
                zEquals = CryptoRuntime.BOUNCY_CASTLE_PROVIDER.equals(provider2 == null ? null : provider2.getName());
            }
    ...
    public final PutObjectResult putInstructionFileSecurely(PutInstructionFileRequest putInstructionFileRequest) {
        ...
        try {
            ...
            return this.s3.putObject(updateInstructionPutRequest(putInstructionFileRequest.createPutObjectRequest(object), encryptionMaterials == null ? contentCryptoMaterialContentCryptoMaterialOf.recreate(putInstructionFileRequest.getMaterialsDescription(), this.kekMaterialsProvider, this.cryptoScheme, this.cryptoConfig.getCryptoProvider(), this.kms, putInstructionFileRequest) : contentCryptoMaterialContentCryptoMaterialOf.recreate(encryptionMaterials, this.kekMaterialsProvider, this.cryptoScheme, this.cryptoConfig.getCryptoProvider(), this.kms, putInstructionFileRequest)));
        } catch (Error e2) {
            IOUtils.closeQuietly(object, this.log);
            throw e2;
    ...
    @Override // com.amazonaws.services.s3.internal.crypto.S3CryptoModule
    public final void putLocalObjectSecurely(UploadObjectRequest uploadObjectRequest, String str, OutputStream outputStream) {
        UploadObjectRequest uploadObjectRequestMo0clone = uploadObjectRequest.mo0clone();
        File file = uploadObjectRequestMo0clone.getFile();
        InputStream inputStream = uploadObjectRequestMo0clone.getInputStream();
        T t = this.multipartUploadContexts.get(str);
        UploadObjectRequest uploadObjectRequest2 = (UploadObjectRequest) wrapWithCipher(uploadObjectRequestMo0clone, t.getContentCryptoMaterial());
        try {
    ...
    public final PutObjectRequest updateInstructionPutRequest(PutObjectRequest putObjectRequest, ContentCryptoMaterial contentCryptoMaterial) {
        ...
        metadata.addUserMetadata(Headers.CRYPTO_INSTRUCTION_FILE, BuildConfig.FLAVOR);
        putObjectRequest.setMetadata(metadata);
    ...
    public abstract <I extends CipherLiteInputStream> SdkFilterInputStream wrapForMultipart(I i2, long j2);
