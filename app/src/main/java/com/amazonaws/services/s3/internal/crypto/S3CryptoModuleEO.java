...
public class S3CryptoModuleEO extends S3CryptoModuleBase<MultipartUploadCbcContext> {
    ...
    public final long ciphertextLength(long j2) {
        ...
        return j2 + (blockSizeInBytes - (j2 % blockSizeInBytes));
    }
    ...
    @Override // com.amazonaws.services.s3.internal.crypto.S3CryptoModuleBase
    public final ByteRangeCapturingInputStream wrapForMultipart(CipherLiteInputStream cipherLiteInputStream, long j2) {
        return new ByteRangeCapturingInputStream(cipherLiteInputStream, j2 - ((long) this.contentCryptoScheme.getBlockSizeInBytes()), j2);
    }
}
