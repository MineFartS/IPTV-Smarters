...
public class CryptoModuleDispatcher extends S3CryptoModule<MultipartUploadContext> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$amazonaws$services$s3$model$CryptoMode;
    ...
    public CryptoModuleDispatcher(AWSKMSClient aWSKMSClient, S3Direct s3Direct, AWSCredentialsProvider aWSCredentialsProvider, EncryptionMaterialsProvider encryptionMaterialsProvider, CryptoConfiguration cryptoConfiguration) {
        ...
        CryptoConfiguration cryptoConfigurationMo2clone = cryptoConfiguration.mo2clone();
        if (cryptoConfigurationMo2clone.getCryptoMode() == null) {
            cryptoConfigurationMo2clone.setCryptoMode(CryptoMode.EncryptionOnly);
        }
        CryptoConfiguration only = cryptoConfigurationMo2clone.readOnly();
        CryptoMode cryptoMode = only.getCryptoMode();
        this.defaultCryptoMode = cryptoMode;
        int i2 = AnonymousClass1.$SwitchMap$com$amazonaws$services$s3$model$CryptoMode[cryptoMode.ordinal()];
        if (i2 == 1) {
            ...
            if (i2 != 2) {
                ...
                CryptoConfiguration cryptoConfigurationMo2clone2 = only.mo2clone();
                try {
                    cryptoConfigurationMo2clone2.setCryptoMode(CryptoMode.AuthenticatedEncryption);
                } catch (UnsupportedOperationException unused) {
                }
                this.ae = new S3CryptoModuleAE(aWSKMSClient, s3Direct, aWSCredentialsProvider, encryptionMaterialsProvider, cryptoConfigurationMo2clone2.readOnly());
                return;
            }
    ...
    @Override // com.amazonaws.services.s3.internal.crypto.S3CryptoModule
    public void putLocalObjectSecurely(UploadObjectRequest uploadObjectRequest, String str, OutputStream outputStream) {
