...
public final class Mimetypes {
    ...
    public Mimetypes() {
        ...
        map.put(Name.LABEL, MIMETYPE_OCTET_STREAM);
    ...
    public String getMimetype(String str) {
        ...
        if (iLastIndexOf <= 0 || (i2 = iLastIndexOf + 1) >= str.length()) {
            log2 = log;
            ...
            String strLowerCase = StringUtils.lowerCase(str.substring(i2));
            ...
            log2 = log;
            if (log2.isDebugEnabled()) {
                str2 = "Extension '" + strLowerCase + "' is unrecognized in mime type listing, using default mime type: '" + MIMETYPE_OCTET_STREAM + "'";
                log2.debug(str2);
            }
        }
