...
public class CredentialsStaxUnmarshaller implements Unmarshaller<Credentials, StaxUnmarshallerContext> {
    ...
    public Credentials unmarshall(StaxUnmarshallerContext staxUnmarshallerContext) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            } else if (staxUnmarshallerContext.testExpression("AccessKeyId", i2)) {
            ...
            } else if (staxUnmarshallerContext.testExpression("SecretAccessKey", i2)) {
            ...
            } else if (staxUnmarshallerContext.testExpression("SessionToken", i2)) {
            ...
            } else if (staxUnmarshallerContext.testExpression("Expiration", i2)) {
