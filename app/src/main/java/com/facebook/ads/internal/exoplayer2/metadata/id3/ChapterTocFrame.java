...
public final class ChapterTocFrame extends Id3Frame {
    ...
    public ChapterTocFrame(Parcel parcel) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            this.A04[i3] = (Id3Frame) parcel.readParcelable(Id3Frame.class.getClassLoader());
        }
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        return this.A02 == chapterTocFrame.A02 && this.A01 == chapterTocFrame.A01 && J1.A0k(this.A00, chapterTocFrame.A00) && Arrays.equals(this.A03, chapterTocFrame.A03) && Arrays.equals(this.A04, chapterTocFrame.A04);
    }

    public final int hashCode() {
        int i2 = ((((17 * 31) + (this.A02 ? 1 : 0)) * 31) + (this.A01 ? 1 : 0)) * 31;
        String str = this.A00;
