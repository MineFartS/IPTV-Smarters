...
import com.facebook.ads.redexgen.X.C0656Dx;
...
public final class EventMessage implements Metadata.Entry {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (this.A03 == eventMessage.A03) {
            ...
            if (j2 == j3 && this.A02 == eventMessage.A02 && J1.A0k(this.A04, eventMessage.A04) && J1.A0k(this.A05, eventMessage.A05) && Arrays.equals(this.A06, eventMessage.A06)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        if (this.A00 == 0) {
            ...
            long j2 = this.A03;
            int i3 = (iHashCode2 + ((int) (j2 ^ (j2 >>> 32)))) * 31;
            long j3 = this.A01;
            int result = (int) (j3 ^ (j3 >>> 32));
            long j4 = this.A02;
            int i4 = (((i3 + result) * 31) + ((int) (j4 ^ (j4 >>> 32)))) * 31;
