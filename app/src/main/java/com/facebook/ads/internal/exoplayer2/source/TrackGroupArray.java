...
import com.facebook.ads.redexgen.X.C0690Fi;
import java.util.Arrays;

/* JADX INFO: loaded from: assets/audience_network.dex */
public final class TrackGroupArray implements Parcelable {
    public static String[] A03;
    public static final TrackGroupArray A04;
    ...
    static {
        A00();
        A04 = new TrackGroupArray(new TrackGroup[0]);
        CREATOR = new C0690Fi();
    }
    ...
    public final TrackGroup A02(int i2) {
        return this.A02[i2];
    }
