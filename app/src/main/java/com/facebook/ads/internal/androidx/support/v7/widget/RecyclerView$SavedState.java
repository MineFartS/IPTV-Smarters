...
import com.facebook.ads.redexgen.X.C4F;

/* JADX INFO: loaded from: assets/audience_network.dex */
@RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
public class RecyclerView$SavedState extends AbsSavedState {
    public static final Parcelable.Creator<RecyclerView$SavedState> CREATOR = new Parcelable.ClassLoaderCreator<RecyclerView$SavedState>() { // from class: com.facebook.ads.redexgen.X.4P
    ...
    public RecyclerView$SavedState(Parcel parcel, ClassLoader classLoader) {
        ...
        this.A00 = parcel.readParcelable(classLoader == null ? C4F.class.getClassLoader() : classLoader);
    }
