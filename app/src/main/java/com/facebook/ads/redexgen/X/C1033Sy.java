...
public class C1033Sy implements AnonymousClass49 {
    ...
    public C1033Sy(C0660Eb c0660Eb) {
        this.A00 = c0660Eb;
    }

    @Override // com.facebook.ads.redexgen.X.AnonymousClass49
    public final void A8v(C4X c4x) {
        c4x.A0a(true);
        if (c4x.A06 != null && c4x.A07 == null) {
            c4x.A06 = null;
        }
        c4x.A07 = null;
        if (!c4x.A0B() && !this.A00.A20(c4x.A0H) && c4x.A0f()) {
            ...
            strArr[0] = "BbBTSQcWyeSpGVnm";
            c0660Eb.removeDetachedView(c4x.A0H, false);
        }
    }
}
