...
public class AnonymousClass39 {
    ...
    public void A03(ViewParent viewParent, View view) {
        if (viewParent instanceof InterfaceC03802d) {
            throw null;
        }
    }
    ...
    public boolean A07(ViewParent viewParent, View view, float f2, float f3) {
        if (viewParent instanceof InterfaceC03802d) {
            return ((InterfaceC03802d) viewParent).onNestedPreFling(view, f2, f3);
        }
        String[] strArr = A00;
        ...
        String[] strArr2 = A00;
        strArr2[2] = "2JlvdJxfzc676EJF51BR6DiplsSASM3N";
        strArr2[2] = "2JlvdJxfzc676EJF51BR6DiplsSASM3N";
        return false;
    }
    ...
    public boolean A08(ViewParent viewParent, View view, float f2, float f3, boolean z) {
        if (viewParent instanceof InterfaceC03802d) {
            return ((InterfaceC03802d) viewParent).onNestedFling(view, f2, f3, z);
        }
        return false;
    }
    ...
    public boolean A09(ViewParent viewParent, View view, View view2, int i2) {
        if (viewParent instanceof InterfaceC03802d) {
            return ((InterfaceC03802d) viewParent).onStartNestedScroll(view, view2, i2);
        }
        return false;
    }
}
