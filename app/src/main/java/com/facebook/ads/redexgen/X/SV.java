...
public class SV<T> implements C2Q<T> {
    ...
    public static void A01() {
        A02 = new byte[]{44, 1, 31, 8, 12, 9, DateTimeFieldType.SECOND_OF_DAY, 77, 4, 3, 77, 25, 5, 8, 77, 29, 2, 2, 1, 76, 76, 112, 125, 56, 117, 121, 96, 56, 104, 119, 119, 116, 56, 107, 113, 98, 125, 56, 117, 109, 107, 108, 56, 122, 125, 56, 38, 56, 40};
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.SV != com.facebook.ads.internal.androidx.support.v4.util.Pools$SimplePool<T> */
    public SV(int i2) {
        if (i2 > 0) {
