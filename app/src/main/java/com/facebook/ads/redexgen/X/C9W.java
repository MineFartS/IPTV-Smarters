...
public class C9W {
    ...
    public C9W(RandomAccessFile randomAccessFile, long[] jArr, long j2) throws IOException {
    ...
    public static C9W A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(416, 3, 41));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C9X.A03);
            randomAccessFile.write(new byte[C9X.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C9W(randomAccessFile, new long[C9X.A03], randomAccessFile.length());
    ...
    */
    public static com.facebook.ads.redexgen.X.C9W A04(java.io.File r14) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 284
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C9W.A04(java.io.File):com.facebook.ads.redexgen.X.9W");
    }
