...
public final class CL {
    ...
    public static void A02() {
        A07 = new byte[]{-25, -5, -22, -17, -11, -75, -13, -10, -21, -19, DateTimeFieldType.SECOND_OF_DAY, 40, DateTimeFieldType.MILLIS_OF_SECOND, 28, 34, -30, 32, 35, 24, 26, -32, -1, -28, 0, DateTimeFieldType.SECOND_OF_DAY, 3, 8, DateTimeFieldType.HOUR_OF_HALFDAY, -50, 12, DateTimeFieldType.CLOCKHOUR_OF_HALFDAY, 4, 6, -52, -21, -47};
    }

    public static void A03() {
        A08 = new String[]{"nifcRfbON53gzILOru2Jo77QmnI", BuildConfig.FLAVOR, "YclbigHQdqatdiMMFtmKc8uyfonoIz5d", "Fd6hY4xBxF4WCtFqE3EitLo6QTPCTd6g", "7NOpBqgVdvht54TmD9wxn6mxDDhXMYkr", "z0qKCLYmn7ETA7vnAfdm8yGWNV", "FyibQKYxxp5WU6WV5DKbmcaitux", "b6Jzn18op"};
    }
    ...
    private void A04(int i2, String str, int i3, int i4, int i5, int i6, int i7) {
        this.A05 = i2;
        this.A06 = str;
        this.A02 = i3;
        this.A03 = i4;
    ...
    public static boolean A05(int version, CL cl) {
        int i2;
        int bitrate;
        int bitrateIndex;
        int i3;
        ...
        cl.A04(i2, str, i5, samplesPerFrame, (frameSize2 & 3) == 3 ? 1 : 2, bitrateIndex2 * 1000, i4);
        return true;
    }
}
