...
@TargetApi(19)
public final class NV extends ProgressBar {
    public static final int A02 = Color.argb(26, 0, 0, 0);
    public static final int A03 = Color.rgb(88, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, 255);
    public Paint A00;
    public Rect A01;

    public NV(X2 x2, AttributeSet attributeSet, int i2) {
