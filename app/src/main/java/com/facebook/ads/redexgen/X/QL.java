...
public final class QL implements Map<String, String> {
    ...
    public QL(Map<String, String> map) {
        this.A00 = map;
    }
    ...
    public final QL A05(String str, String str2) {
        this.A00.put(str, str2);
        return this;
    }

    public final QL A06(Map<? extends String, ? extends String> arg) {
        putAll(arg);
        return this;
    }
