...
public final class Y6 implements InterfaceC0593Ay {
    ...
    @Nullable
    public int[] A07;
    public ByteBuffer A02 = InterfaceC0593Ay.A00;
    ...
    public final boolean A7e() {
        return this.A05 && this.A03 == InterfaceC0593Ay.A00;
    }
    ...
    public final void ABy(ByteBuffer byteBuffer) {
        IM.A04(this.A06 != null);
        int outputSize = byteBuffer.position();
        int iLimit = byteBuffer.limit();
        int limit = this.A00;
        int i2 = (iLimit - outputSize) / (limit * 2);
