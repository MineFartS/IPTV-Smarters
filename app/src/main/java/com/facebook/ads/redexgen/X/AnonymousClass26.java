...
public final class AnonymousClass26 implements Serializable {
    ...
    public AnonymousClass26(int i2, @Nullable String str, String str2) {
    ...
    private void A00(AnonymousClass26 anonymousClass26) {
    ...
    public final void A06(AnonymousClass26 anonymousClass26) {
        anonymousClass26.A00(this);
        this.A04.add(anonymousClass26);
    }
}
