...
public final class HF {
    ...
    public static void A03() {
        A00 = new byte[]{-78, -101, -49, 2, -6, -17, -19, -2, -17, -18, -86, -31, -49, -52, -32, -34, -34, -72, -86, -47, -7, -2, -86, -38, -17, -4, -19, -17, -8, -2, -21, -15, -17, -3, -86, -9, -1, -3, -2, -86, -17, -8, -18, -86, 1, -13, -2, -14, -86, -81, 32, -14, -29, -45, -44, -39, -54, -83, -83, -91, 1, -114, -82, -77, -81, -82, -60, -87, 53, -58, -110, -106, DateTimeFieldType.MILLIS_OF_DAY, 46, 28, 25, 45, 43, 43, -1, -1, -9, 83, -32, 0, 5, 1, 0, DateTimeFieldType.MILLIS_OF_DAY, -5};
        if (A01[5].charAt(7) == 'A') {
    ...
    public static long A01(String str) throws NumberFormatException {
        long j2 = 0;
        String[] strArrA0q = J1.A0q(str, A02(50, 2, 102));
        for (String subpart : J1.A0p(strArrA0q[0], A02(1, 1, 3))) {
            j2 = (60 * j2) + Long.parseLong(subpart);
        }
        long j3 = j2 * 1000;
        if (strArrA0q.length == 2) {
            String str2 = strArrA0q[1];
            String[] subparts = A01;
    ...
    public static void A05(C0768Il c0768Il) throws C0709Gc {
        String line = c0768Il.A0Q();
        if (line != null && A03.matcher(line).matches()) {
            return;
        }
        throw new C0709Gc(A02(2, 21, 44) + line);
    }
}
