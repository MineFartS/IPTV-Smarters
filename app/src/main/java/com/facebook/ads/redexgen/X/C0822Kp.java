...
public final class C0822Kp {
    ...
    public static final AtomicReference<InterfaceC0820Kn> A02 = new AtomicReference<>();
    ...
    public static void A01(boolean z, InterfaceC0820Kn interfaceC0820Kn) {
        A01.set(z);
