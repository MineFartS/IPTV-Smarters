...
public final class DialogC1236aN extends Dialog implements C8A {
    ...
    static {
        A02();
        A08 = (int) (C0856Lz.A01 * 16.0f);
        A07 = Color.parseColor(A00(0, 7, 47));
    }

    public DialogC1236aN(X2 x2, Activity activity) {
        super(activity);
        this.A05 = x2;
        setCancelable(false);
    ...
    private void A01() {
        ...
        int i2 = A08;
        relativeLayout.setPadding(i2, i2, i2 / 2, i2 / 2);
        ...
        this.A04.setTextColor(DefaultRenderer.BACKGROUND_COLOR);
        this.A04.setPadding(0, 0, 0, A08);
        C0856Lz.A0b(this.A04, true, 18);
        ...
        C0856Lz.A0W(this.A01, gradientDrawable2);
        C0856Lz.A0N(this.A00);
        this.A00.setAllCaps(true);
        this.A00.setGravity(17);
        C0856Lz.A0P(this.A00, -1);
