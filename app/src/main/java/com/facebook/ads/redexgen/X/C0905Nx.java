...
public final class C0905Nx extends View {
    ...
    public static void A01() {
        A05 = new byte[]{0, 2, 31, DateTimeFieldType.MILLIS_OF_SECOND, 2, DateTimeFieldType.SECOND_OF_MINUTE, 3, 3};
    }

    public C0905Nx(X2 x2) {
        super(x2);
    ...
    public final void onMeasure(int i2, int i3) {
        int iMin = Math.min(getDefaultSize(getSuggestedMinimumHeight(), i3), getDefaultSize(getSuggestedMinimumWidth(), i2));
    ...
    public void setProgressWithAnimation(float f2) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, A00(0, 8, 32), f2);
