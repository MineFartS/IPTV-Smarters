...
public final class C05047d extends KS {
    ...
    public C05047d(X2 x2) {
        super(x2);
        this.A00 = null;
        this.A01 = new KQ() { // from class: com.facebook.ads.redexgen.X.7h
        ...
        this.A02 = new KK() { // from class: com.facebook.ads.redexgen.X.7g
            public static byte[] A01;
