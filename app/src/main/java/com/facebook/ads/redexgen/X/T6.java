...
public abstract class T6 extends C4B {
    ...
    public abstract boolean A0W(C4X c4x, int i2, int i3, int i4, int i5);

    public abstract boolean A0X(C4X c4x, C4X c4x2, int i2, int i3, int i4, int i5);
    ...
    public final boolean A0L(@NonNull C4X c4x, @NonNull C4X c4x2, @NonNull C4A c4a, @NonNull C4A c4a2) {
        ...
        strArr[1] = "7F8ns227Orjao7";
        return A0X(c4x, c4x2, i2, i3, fromTop, toLeft);
    }
