...
public final class C0767Ik {
    ...
    public C0767Ik(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C0767Ik(byte[] bArr, int i2) {
        this.A00 = bArr;
        this.A02 = i2;
    }
    ...
    private void A00() {
        int i2;
        int i3 = this.A03;
        IM.A04(i3 >= 0 && (i3 < (i2 = this.A02) || (i3 == i2 && this.A01 == 0)));
    }
    ...
    public final void A0B(int i2, int firstByteReadSize) {
        ...
        int i3 = (8 - firstByteRightPaddingSize) - iMin;
        byte[] bArr = this.A00;
        int i4 = this.A03;
        bArr[i4] = (byte) (bArr[i4] & ((65280 >> firstByteRightPaddingSize) | ((1 << i3) - 1)));
        int firstByteInputBits = bArr[i4];
        bArr[i4] = (byte) (firstByteInputBits | ((i2 >>> (firstByteReadSize - iMin)) << i3));
    ...
    public final void A0D(byte[] bArr, int i2) {
        this.A00 = bArr;
        this.A03 = 0;
        this.A01 = 0;
        this.A02 = i2;
    ...
    public final void A0E(byte[] bArr, int i2, int i3) {
        ...
        if (i7 != 0) {
            ...
            byte[] bArr4 = this.A00;
            int i11 = this.A03;
            int i12 = 255 & bArr4[i11];
            int i13 = this.A01;
            bArr[i4] = (byte) (bArr[i4] | ((byte) ((i12 >> (8 - i13)) << (8 - i7))));
            if (i13 == 8) {
                this.A01 = 0;
                this.A03 = i11 + 1;
            }
    ...
    public final void A0F(byte[] bArr, int i2, int i3) {
        IM.A04(this.A01 == 0);
