...
public final class C9M {
    ...
    public final int A05(C9M c9m) {
        int i2 = this.A00;
        int i3 = c9m.A00;
        if (i2 != i3) {
            return i2 - i3;
        }
        return this.A01 - c9m.A01;
    }

    public final C9M A06(int i2) {
        int i3 = this.A01;
        if (i2 + i3 >= 0) {
            return new C9M(this.A00, i3 + i2);
        }
