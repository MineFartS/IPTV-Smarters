...
public final class L9 implements Window.Callback {
    public static final List<L8> A02 = Collections.synchronizedList(new ArrayList());
    public Activity A00;
    public Window.Callback A01;

    public L9(Window.Callback callback, Activity activity) {
        this.A01 = callback;
        this.A00 = activity;
    }

    public static void A00(L8 l8) {
        A02.add(l8);
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        Iterator<L8> it = A02.iterator();
        while (it.hasNext()) {
            it.next().A4q(motionEvent);
        }
    ...
    public final boolean onCreatePanelMenu(int i2, Menu menu) {
        return this.A01.onCreatePanelMenu(i2, menu);
    }

    @Override // android.view.Window.Callback
    @Nullable
    public final View onCreatePanelView(int i2) {
        return this.A01.onCreatePanelView(i2);
    }
    ...
    public final boolean onMenuItemSelected(int i2, MenuItem menuItem) {
        return this.A01.onMenuItemSelected(i2, menuItem);
    }

    @Override // android.view.Window.Callback
    public final boolean onMenuOpened(int i2, Menu menu) {
        return this.A01.onMenuOpened(i2, menu);
    }

    @Override // android.view.Window.Callback
    public final void onPanelClosed(int i2, Menu menu) {
        this.A01.onPanelClosed(i2, menu);
    }

    @Override // android.view.Window.Callback
    public final boolean onPreparePanel(int i2, View view, Menu menu) {
        return this.A01.onPreparePanel(i2, view, menu);
    }
    ...
    public final ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i2) {
        return this.A01.onWindowStartingActionMode(callback, i2);
    }
}
