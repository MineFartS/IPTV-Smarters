...
public final class WL extends C6U {
    ...
    static {
        A09();
        A08();
        A05 = WL.class.getSimpleName();
    }

    public WL(Context context, C04715u c04715u) {
    ...
    public AbstractC04956s A02(HashMap<String, WK> map) {
        return new C1132Wt(SystemClock.elapsedRealtime(), A01, map, EnumC04946r.A0C);
    }
