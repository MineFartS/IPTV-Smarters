...
public enum AnonymousClass10 {
    ...
    public static void A01() {
        A01 = new byte[]{99, 116, 99, 107, 110, 99, 96, 110, 103, 125, 124, 108, 125, 114, 103, 122, 101, 118, 108, 114, 119, 108, 127, 114, 106, 124, 102, 103, 105, 114, 114, 98, 110, 112, 124, 113, 113, 0, DateTimeFieldType.MILLIS_OF_SECOND, 0, 8, DateTimeFieldType.HALFDAY_OF_DAY, 0, 3, DateTimeFieldType.HALFDAY_OF_DAY, 4, 44, 45, 29, 44, 35, 54, 43, 52, 39, 29, 35, 38, 29, 46, 35, 59, 45, 55, 54, 43, 48, 48, 0, 44, 50, 62, 51, 51};
