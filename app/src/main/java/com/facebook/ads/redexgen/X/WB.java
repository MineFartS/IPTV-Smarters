...
public class WB implements InterfaceC04866j {
    ...
    public final boolean A7f(Object obj) {
        WB wb = (WB) obj;
        if (this.A03 == wb.A03 && this.A04 == wb.A04 && Math.abs(this.A00 - wb.A00) < C04715u.A01() && this.A05 == wb.A05 && AnonymousClass71.A0G(this.A0I, wb.A0I) && Math.abs(this.A01 - wb.A01) < C04715u.A01() && Math.abs(this.A02 - wb.A02) < C04715u.A01() && this.A06 == wb.A06 && AnonymousClass71.A0G(this.A0J, wb.A0J)) {
            int i2 = this.A07;
            int i3 = wb.A07;
            String[] strArr = A0L;
