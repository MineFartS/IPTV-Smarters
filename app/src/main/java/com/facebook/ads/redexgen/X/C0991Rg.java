...
public final class C0991Rg extends AbstractC03400p {
    ...
    @Nullable
    public View A01;
    public EnumC03500z A02;
    public AnonymousClass10 A03;
    public EnumC0806Jx A04;
    ...
    public C0991Rg(X2 x2, AbstractC03410q abstractC03410q, Q2 q2, C0986Rb c0986Rb) {
        super(x2, abstractC03410q, q2);
        this.A02 = EnumC03500z.A03;
        this.A03 = null;
        this.A0D = c0986Rb;
    }
    ...
    private String A03(View view) {
        ...
        try {
            ...
            bitmapCreateBitmap.compress(Bitmap.CompressFormat.JPEG, this.A0D.A0E(), byteArrayOutputStream);
    ...
    */
    private org.json.JSONObject A04(android.view.View r10) throws org.json.JSONException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0991Rg.A04(android.view.View):org.json.JSONObject");
    }
    ...
    public final void A07(Map<String, String> map) {
        ...
        EnumC0806Jx enumC0806Jx = this.A04;
        if (enumC0806Jx != null) {
            map.put(A01(97, 3, 121), String.valueOf(enumC0806Jx.A04()));
        }
        if (this.A07) {
        ...
        EnumC03500z enumC03500z = this.A02;
        if (enumC03500z != null) {
            map.put(A01(106, 14, 33), enumC03500z.toString());
        }
        if (this.A09) {
        ...
        strArr[0] = "P6MGDEoKncCrYirOOQ1jmq4l0Ss52l96";
        if (view != null) {
            map.put(A01(69, 4, 45), String.valueOf((int) (view.getWidth() / C0856Lz.A01)));
            map.put(A01(65, 4, 34), String.valueOf((int) (this.A01.getHeight() / C0856Lz.A01)));
        }
    ...
    public final void A0A(EnumC03500z enumC03500z) {
        this.A02 = enumC03500z;
    }
    ...
    public final void A0C(EnumC0806Jx enumC0806Jx) {
        this.A04 = enumC0806Jx;
    }
