...
public final class C0805Jw implements NativeAdViewAttributesApi {
    public static final int A08 = (int) (C0856Lz.A01 * 4.0f);
    public static final int A07 = (int) (C0856Lz.A01 * 1.0f);
    ...
    public final int A04(float f2) {
        int i2 = this.A01;
        return C2G.A02(((-16777216) & i2) | ((i2 ^ (-1)) & 16777215), i2, f2);
    }
    ...
    public final void A05(TextView textView) {
        ...
        C0856Lz.A0W(textView, stateListDrawable);
