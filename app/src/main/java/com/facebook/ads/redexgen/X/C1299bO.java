...
public final class C1299bO extends C0747Hq {
    ...
    public static void A01() {
        A01 = new byte[]{DateTimeFieldType.HALFDAY_OF_DAY, 42, 50, 37, 40, 45, 32, 100, 39, 43, 42, 48, 33, 42, 48, 100, 48, 61, 52, 33, 126, 100};
    ...
    public C1299bO(String str, C0744Hl c0744Hl) {
        super(A00(0, 22, 123) + str, c0744Hl, 1);
        this.A00 = str;
    }
}
