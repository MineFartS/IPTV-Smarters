...
public class JQ implements ServiceConnection {
    ...
    public static void A01() {
        A01 = new byte[]{4, DateTimeFieldType.MILLIS_OF_DAY, 35, 39, 26, DateTimeFieldType.SECOND_OF_DAY, DateTimeFieldType.MILLIS_OF_DAY, -47, DateTimeFieldType.SECOND_OF_DAY, 32, 31, 31, DateTimeFieldType.MILLIS_OF_DAY, DateTimeFieldType.SECOND_OF_DAY, 37, DateTimeFieldType.MILLIS_OF_DAY, DateTimeFieldType.SECOND_OF_MINUTE, -23, -5, 8, 12, -1, -7, -5, -74, -6, -1, 9, -7, 5, 4, 4, -5, -7, 10, -5, -6};
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        this.A00.A08(C05228d.A1W, new C05238e(A00(0, 17, 51)));
        this.A00.A01 = true;
        ...
        try {
            ...
            this.A00.A07(C05228d.A1V, new C05238e(e2));
        }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        this.A00.A08(C05228d.A1X, new C05238e(A00(17, 20, 24)));
        try {
            this.A00.A03.unbindService(this);
