...
public class C0640Df extends Exception {
    ...
    public C0640Df(Format format, Throwable th, boolean z, int i2) {
    ...
    public C0640Df(Format format, Throwable th, boolean z, String str) {
        super(A01(2, 21, 92) + str + A01(0, 2, 21) + format, th);
        this.A02 = format.A0O;
        this.A03 = z;
        this.A00 = str;
        this.A01 = J1.A02 >= 21 ? A02(th) : null;
    }

    public static String A00(int i2) {
        return A01(48, 53, 91) + (i2 < 0 ? A01(101, 4, 95) : A01(0, 0, 105)) + Math.abs(i2);
    }
