...
public final class C5C implements NativeAdsManagerApi {
    ...
    public static void A01() {
        A0A = new byte[]{27, 60, 52, 49, 56, 57, 125, 41, 50, 125, 52, 51, 52, 41, 52, 60, 49, 52, 39, 56, 125, 30, 50, 50, 54, 52, 56, DateTimeFieldType.CLOCKHOUR_OF_DAY, 60, 51, 60, 58, 56, 47, 115};
    }
    ...
    public C5C(Context context, String str, int i2) {
        this.A07 = AnonymousClass52.A02(context);
        this.A08 = str;
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        ...
        int i2 = this.A06;
        S5 s5 = this.A02;
        this.A02 = new S5(this.A07, this.A08, kd, null, i2);
        if (this.A05) {
            this.A02.A07();
        }
        this.A02.A0A(this.A03);
        this.A02.A09(new TV(this, this.A07, mediaCacheFlag));
        this.A02.A08();
    }
