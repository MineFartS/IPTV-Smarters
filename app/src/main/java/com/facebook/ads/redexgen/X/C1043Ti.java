...
public final class C1043Ti implements InterfaceC04615k {
    public static String[] A01;
    public final Map<String, C04595i> A00 = new HashMap();
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC04615k
    public final synchronized String ACW() {
        StringBuilder sb;
        sb = new StringBuilder();
        for (C04595i stat : this.A00.values()) {
