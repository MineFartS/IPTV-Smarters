...
public final class C0697Fq extends RE {
    ...
    public final boolean A0A(File file, long j2, int i2) {
        return j2 <= this.A00;
    }

    @Override // com.facebook.ads.redexgen.X.RE, com.facebook.ads.redexgen.X.C0C
    public final /* bridge */ /* synthetic */ void ADa(File file) throws IOException {
        super.ADa(file);
    }
}
