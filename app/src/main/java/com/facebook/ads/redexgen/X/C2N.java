...
public final class C2N<K, V> implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    ...
    public static void A03() {
        A05 = new String[]{"XqZAhum", "ZDgQMvtBgNrA71zPtdKPERKXDyY", BuildConfig.FLAVOR, "fQnh1QnAdjSL19mcL6hVXdKAmOMxUcoe", "Jl6IPYfhih6t3CzPawLUV", "5ptyQxfboOWL43Tud8kOlHSoYTCJZrHB", "GBGqVCnWWQQidVcjkSktabcuIfs5iNWm", "2xozQVjtj3EM4viJRxfTyERGPuYGzhPM"};
    }
    ...
    public final int hashCode() {
        if (this.A02) {
            Object objA08 = this.A03.A08(this.A01, 0);
            Object objA082 = this.A03.A08(this.A01, 1);
            int iHashCode = (objA082 != null ? objA082.hashCode() : 0) ^ (objA08 == null ? 0 : objA08.hashCode());
            if (A05[4].length() != 21) {
