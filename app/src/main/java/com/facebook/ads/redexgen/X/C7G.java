    ...
    */
    public static int A00(android.graphics.BitmapFactory.Options r3, int r4, int r5) {
        ...
        L18:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C7G.A00(android.graphics.BitmapFactory$Options, int, int):int");
    }
    ...
    public static Bitmap A02(String str, int i2, int i3, C8C c8c) {
        try {
            BitmapFactory.Options options = new BitmapFactory.Options();
            options.inJustDecodeBounds = true;
            ...
            c8c.A04().A86(A03(0, 5, 99), C05228d.A1M, new C05238e(th));
            return null;
        }
    }
}
