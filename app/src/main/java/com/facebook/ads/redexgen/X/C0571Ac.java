...
public final class C0571Ac {
    ...
    public final long A0A(int i2, int i3) {
        C0691Fk c0691Fk = this.A05.A04[i2];
        if (c0691Fk.A00 != -1) {
            return c0691Fk.A02[i3];
        }
        return -9223372036854775807L;
    }

    public final C0571Ac A0B(Object obj, Object obj2, int i2, long j2, long j3) {
        return A0C(obj, obj2, i2, j2, j3, C0693Fm.A06);
    }

    public final C0571Ac A0C(Object obj, Object obj2, int i2, long j2, long j3, C0693Fm c0693Fm) {
        this.A02 = obj;
        this.A03 = obj2;
        this.A00 = i2;
        this.A01 = j2;
    ...
    public final boolean A0E(int i2, int i3) {
        C0691Fk c0691Fk = this.A05.A04[i2];
        return (c0691Fk.A00 == -1 || c0691Fk.A01[i3] == 0) ? false : true;
    }
}
