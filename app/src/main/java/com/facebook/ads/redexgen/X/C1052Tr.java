...
public final class C1052Tr implements AnonymousClass63 {
    ...
    public static void A01() {
        byte[] bArr = {74, 119, 108, 106, 127, 123, 102, 96, 97, 47, 109, 122, 102, 99, 107, 102, 97, 104, 47, 73, 78, 65, 47, 99, 96, 104, 104, 102, 97, 104, 47, 69, 92, 64, 65, 122, 81, 70, 81, 30, 24, 35, 24, 29, 8, 29, 35, DateTimeFieldType.CLOCKHOUR_OF_DAY, DateTimeFieldType.MINUTE_OF_HOUR, 27, 27, DateTimeFieldType.SECOND_OF_MINUTE, DateTimeFieldType.MINUTE_OF_DAY, 27, 96, 107, 102, 5, 66, 74, DateTimeFieldType.MILLIS_OF_DAY, 0, 7, 38, 55, 92, 1, 10, 12};
        String[] strArr = A02;
    ...
    static {
        A02();
        A01();
        A03 = C1052Tr.class.getSimpleName();
    }

    public C1052Tr(X3 x3) {
        this.A00 = x3;
    }
    ...
    public final void A8F(String str, String str2, Map<String, String> map, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6) {
        ...
        try {
            ...
            C05238e c05238e = new C05238e(jSONObject.toString());
            c05238e.A03(1);
            this.A00.A04().A87(A00(39, 15, 77), 3202, c05238e);
