...
public abstract class AbstractC1280b5 implements HT {
    ...
    public AbstractC1280b5(TrackGroup trackGroup, int... iArr) {
        IM.A04(iArr.length > 0);
        this.A04 = (TrackGroup) IM.A01(trackGroup);
        this.A03 = iArr.length;
        this.A02 = new Format[this.A03];
        for (int i2 = 0; i2 < iArr.length; i2++) {
            this.A02[i2] = trackGroup.A02(iArr[i2]);
        }
        Arrays.sort(this.A02, new HH());
        this.A05 = new int[this.A03];
        int i3 = 0;
        while (true) {
            int i4 = this.A03;
            if (i3 < i4) {
                this.A05[i3] = trackGroup.A01(this.A02[i3]);
                i3++;
            } else {
    ...
    public final boolean A02(int i2, long j2) {
    ...
    @Override // com.facebook.ads.redexgen.X.HT
    public final Format A6M(int i2) {
        return this.A02[i2];
    }

    @Override // com.facebook.ads.redexgen.X.HT
    public final int A6R(int i2) {
        return this.A05[i2];
    }

    @Override // com.facebook.ads.redexgen.X.HT
    public final Format A6y() {
        return this.A02[A6z()];
    }

    @Override // com.facebook.ads.redexgen.X.HT
    public final TrackGroup A7D() {
        return this.A04;
    }

    @Override // com.facebook.ads.redexgen.X.HT
    public void AAW(float f2) {
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        AbstractC1280b5 abstractC1280b5 = (AbstractC1280b5) obj;
        return this.A04 == abstractC1280b5.A04 && Arrays.equals(this.A05, abstractC1280b5.A05);
    }
