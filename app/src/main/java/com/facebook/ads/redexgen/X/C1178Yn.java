...
public final class C1178Yn implements CZ {
    public static String[] A01;
    public final /* synthetic */ C1179Yo A00;
    ...
    public C1178Yn(C1179Yo c1179Yo) {
        this.A00 = c1179Yo;
    }

    public /* synthetic */ C1178Yn(C1179Yo c1179Yo, C1177Ym c1177Ym) {
        this(c1179Yo);
    }

    @Override // com.facebook.ads.redexgen.X.CZ
    public final void A3r(int i2, int i3, CG cg) throws InterruptedException, IOException {
        this.A00.A0L(i2, i3, cg);
    }

    @Override // com.facebook.ads.redexgen.X.CZ
    public final void A4w(int i2) throws AI {
        this.A00.A0J(i2);
    }

    @Override // com.facebook.ads.redexgen.X.CZ
    public final void A59(int i2, double d2) throws AI {
        this.A00.A0K(i2, d2);
    }

    @Override // com.facebook.ads.redexgen.X.CZ
    public final int A68(int i2) {
        switch (i2) {
            case 131:
            case 136:
            case 155:
    ...
    @Override // com.facebook.ads.redexgen.X.CZ
    public final void A7Y(int i2, long j2) throws AI {
        this.A00.A0M(i2, j2);
    }

    @Override // com.facebook.ads.redexgen.X.CZ
    public final boolean A7j(int i2) {
        if (i2 != 357149030) {
    ...
    @Override // com.facebook.ads.redexgen.X.CZ
    public final void ADN(int i2, long j2, long j3) throws AI {
        this.A00.A0N(i2, j2, j3);
    }

    @Override // com.facebook.ads.redexgen.X.CZ
    public final void ADU(int i2, String str) throws AI {
        this.A00.A0O(i2, str);
    }
}
