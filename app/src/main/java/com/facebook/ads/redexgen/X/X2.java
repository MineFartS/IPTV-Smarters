...
public class X2 extends C8C {
    ...
    public X2(Activity activity, C8E c8e, C0S c0s) {
        super(activity.getApplicationContext(), c8e);
    ...
    public X2(Context context, C8E c8e, C0S c0s) {
        super(context.getApplicationContext(), c8e);
        this.A00 = new WeakHashMap<>();
        this.A02 = new AtomicReference<>();
        this.A02.set(c0s);
    ...
    public static Activity A00(Context context) {
        while (true) {
            ...
            if (z) {
                ...
                if ((context instanceof X2) && ((X2) context).A09() != null) {
                    return ((X2) context).A09();
                }
    ...
    public final void A0D(X2 x2) {
        x2.A00.putAll(this.A00);
        this.A00 = x2.A00;
    }
