...
public class ParameterFactory {
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, Annotation annotation2, int i2) {
        ...
        return (Parameter) (annotation2 != null ? constructor2.newInstance(constructor, annotation, annotation2, this.format, Integer.valueOf(i2)) : constructor2.newInstance(constructor, annotation, this.format, Integer.valueOf(i2)));
    }
}
