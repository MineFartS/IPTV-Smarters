...
public class DateTimeFormatter {
    ...
    private void printTo(Appendable appendable, long j2, Chronology chronology) {
        ...
        internalPrinterRequirePrinter.printTo(appendable, j4, chronologySelectChronology.withUTC(), offset, zone, this.iLocale);
    }
