...
public class DateTimeZoneBuilder {
    ...
    public static final class OfYear {
        ...
        public OfYear(char c2, int i2, int i3, int i4, boolean z, int i5) {
            if (c2 != 'u' && c2 != 'w' && c2 != 's') {
        ...
        public long setInstant(int i2, int i3, int i4) {
            ...
            ISOChronology instanceUTC = ISOChronology.getInstanceUTC();
            long dayOfMonth = setDayOfMonth(instanceUTC, instanceUTC.millisOfDay().set(instanceUTC.monthOfYear().set(instanceUTC.year().set(0L, i2), this.iMonthOfYear), this.iMillisOfDay));
            if (this.iDayOfWeek != 0) {
    ...
    public static final class PrecalculatedZone extends DateTimeZone {
        ...
        public static PrecalculatedZone create(String str, boolean z, ArrayList<Transition> arrayList, DSTZone dSTZone) {
            ...
            while (i2 < size - 1) {
                ...
                if (j2 != j3 && j4 == j5 && str2.equals(str3) && period.getYears() == 0 && period.getMonths() > 4 && period.getMonths() < 8 && str2.equals(strArr5[2]) && str2.equals(strArr5[4])) {
                    if (ZoneInfoCompiler.verbose()) {
                        ...
                        System.out.println("     - " + new DateTime(jArr[i2], instanceUTC) + " - " + new DateTime(jArr[i4], instanceUTC));
                    }
                    if (j2 > j3) {
            ...
            return new PrecalculatedZone(z ? str : BuildConfig.FLAVOR, jArr, iArr5, iArr6, strArr6, dSTZone2);
        }
        ...
        public long nextTransition(long j2) {
            long[] jArr = this.iTransitions;
            int iBinarySearch = Arrays.binarySearch(jArr, j2);
            int i2 = iBinarySearch >= 0 ? iBinarySearch + 1 : iBinarySearch ^ (-1);
            if (i2 < jArr.length) {
                return jArr[i2];
            }
            DSTZone dSTZone = this.iTailZone;
        ...
        public void writeTo(DataOutput dataOutput) throws IOException {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                ...
                DateTimeZoneBuilder.writeMillis(dataOutput, this.iWallOffsets[i5]);
                DateTimeZoneBuilder.writeMillis(dataOutput, this.iStandardOffsets[i5]);
    ...
    public static final class Rule {
        ...
        public Rule(Recurrence recurrence, int i2, int i3) {
        ...
        public long next(long j2, int i2, int i3) {
            ISOChronology instanceUTC = ISOChronology.getInstanceUTC();
            int i4 = i2 + i3;
            long next = this.iRecurrence.next(((j2 > Long.MIN_VALUE ? 1 : (j2 == Long.MIN_VALUE ? 0 : -1)) == 0 ? Integer.MIN_VALUE : instanceUTC.year().get(((long) i4) + j2)) < this.iFromYear ? (instanceUTC.year().set(0L, this.iFromYear) - ((long) i4)) - 1 : j2, i2, i3);
            return (next <= j2 || instanceUTC.year().get(((long) i4) + next) <= this.iToYear) ? next : j2;
        }
    }
    ...
    public static final class Transition {
        ...
        public Transition(long j2, String str, int i2, int i3) {
            this.iMillis = j2;
            this.iNameKey = str;
            this.iWallOffset = i2;
        ...
        public Transition(long j2, Rule rule, int i2) {
            this.iMillis = j2;
    ...
    public static void writeMillis(DataOutput dataOutput, long j2) throws IOException {
        if (j2 % 1800000 == 0) {
            long j3 = j2 / 1800000;
            if (((j3 << 58) >> 58) == j3) {
    ...
    public DateTimeZoneBuilder addCutover(int i2, char c2, int i3, int i4, int i5, boolean z, int i6) {
        if (this.iRuleSets.size() > 0) {
            this.iRuleSets.get(r10.size() - 1).setUpperLimit(i2, new OfYear(c2, i3, i4, i5, z, i6));
        }
        this.iRuleSets.add(new RuleSet());
        return this;
    }

    public DateTimeZoneBuilder addRecurringSavings(String str, int i2, int i3, int i4, char c2, int i5, int i6, int i7, boolean z, int i8) {
        if (i3 <= i4) {
            getLastRuleSet().addRule(new Rule(new Recurrence(new OfYear(c2, i5, i6, i7, z, i8), str, i2), i3, i4));
        }
        return this;
    }
