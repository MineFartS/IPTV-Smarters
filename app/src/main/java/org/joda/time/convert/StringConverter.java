    ...
    public long getDurationMillis(Object obj) {
        ...
        if (length >= 4 && ((str.charAt(0) == 'P' || str.charAt(0) == 'p') && (str.charAt(1) == 'T' || str.charAt(1) == 't'))) {
            ...
            if (str.charAt(i2) == 'S' || str.charAt(i2) == 's') {
                ...
                if (i4 > 0) {
                    j2 = Long.parseLong(strSubstring.substring(i3, i4));
                    ...
                    j2 = i3 != 0 ? Long.parseLong(strSubstring.substring(i3, strSubstring.length())) : Long.parseLong(strSubstring);
                    j3 = 0;
                }
                return i3 != 0 ? FieldUtils.safeAdd(FieldUtils.safeMultiply(-j2, 1000), -j3) : FieldUtils.safeAdd(FieldUtils.safeMultiply(j2, 1000), j3);
            }
        }
        throw new IllegalArgumentException("Invalid format: \"" + str + '\"');
    }
