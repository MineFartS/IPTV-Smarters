...
public abstract class BasicChronology extends AssembledChronology {
    ...
    public long getDateTimeMillis(int i2, int i3, int i4, int i5) {
        ...
        return getDateMidnightMillis(i2, i3, i4) + ((long) i5);
    }
    ...
    public long getDateTimeMillis(int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        return getDateMidnightMillis(i2, i3, i4) + ((long) (i5 * DateTimeConstants.MILLIS_PER_HOUR)) + ((long) (i6 * DateTimeConstants.MILLIS_PER_MINUTE)) + ((long) (i7 * 1000)) + ((long) i8);
    }
    ...
    public int getDayOfMonth(long j2, int i2, int i3) {
        return ((int) ((j2 - (getYearMillis(i2) + getTotalMillisByYearMonth(i2, i3))) / TimeChart.DAY)) + 1;
    }
    ...
    public int getDayOfYear(long j2, int i2) {
        return ((int) ((j2 - getYearMillis(i2)) / TimeChart.DAY)) + 1;
    }
    ...
    public int getMillisOfDay(long j2) {
        return j2 >= 0 ? (int) (j2 % TimeChart.DAY) : ((int) ((j2 + 1) % TimeChart.DAY)) + 86399999;
    }
    ...
    public long getYearMonthDayMillis(int i2, int i3, int i4) {
        return getYearMillis(i2) + getTotalMillisByYearMonth(i2, i3) + (((long) (i4 - 1)) * TimeChart.DAY);
    }
