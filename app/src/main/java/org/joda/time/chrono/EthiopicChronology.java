...
public final class EthiopicChronology extends BasicFixedMonthChronology {
    ...
    public EthiopicChronology(Chronology chronology, Object obj, int i2) {
                ...
                synchronized (ethiopicChronologyArr) {
                    ...
                    if (ethiopicChronology2 == null) {
                        ...
                        if (dateTimeZone == dateTimeZone2) {
                            ...
                            ethiopicChronology = new EthiopicChronology(LimitChronology.getInstance(ethiopicChronology3, new DateTime(1, 1, 1, 0, 0, 0, 0, ethiopicChronology3), null), null, i2);
                        } else {
                            ethiopicChronology = new EthiopicChronology(ZonedChronology.getInstance(getInstance(dateTimeZone2, i2), dateTimeZone), null, i2);
                        }
