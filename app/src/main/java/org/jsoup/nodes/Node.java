...
public abstract class Node implements Cloneable {
    ...
    public String absUrl(String str) {
        ...
        return !hasAttr(str) ? BuildConfig.FLAVOR : StringUtil.resolve(this.baseUri, attr(str));
    }
    ...
    public String attr(String str) {
        Validate.notNull(str);
        return this.attributes.hasKey(str) ? this.attributes.get(str) : str.toLowerCase().startsWith("abs:") ? absUrl(str.substring(4)) : BuildConfig.FLAVOR;
    }
    ...
    public boolean hasAttr(String str) {
        ...
        if (str.startsWith("abs:")) {
            ...
            if (this.attributes.hasKey(strSubstring) && !absUrl(strSubstring).equals(BuildConfig.FLAVOR)) {
                return true;
            }
        }
    ...
    public Node previousSibling() {
        int i2;
        Node node = this.parentNode;
        if (node != null && (i2 = this.siblingIndex) > 0) {
            return node.childNodes.get(i2 - 1);
        }
        return null;
    }
