...
public abstract class Token {
    ...
    public static abstract class Tag extends Token {
        ...
        public final void newAttribute() {
            ...
            if (this.pendingAttributeName != null) {
                this.attributes.put(this.hasPendingAttributeValue ? new Attribute(this.pendingAttributeName, this.pendingAttributeValue.toString()) : this.hasEmptyAttributeValue ? new Attribute(this.pendingAttributeName, BuildConfig.FLAVOR) : new BooleanAttribute(this.pendingAttributeName));
            }
