...
public abstract class Evaluator {
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        public boolean matches(Element element, Element element2) {
            ...
            int i2 = this.f31373a;
            if (i2 == 0) {
                return iCalculatePosition == this.f31374b;
            }
            int i3 = this.f31374b;
        ...
        public String toString() {
            return this.f31373a == 0 ? String.format(":%s(%d)", getPseudoClass(), Integer.valueOf(this.f31374b)) : this.f31374b == 0 ? String.format(":%s(%dn)", getPseudoClass(), Integer.valueOf(this.f31373a)) : String.format(":%s(%dn%+d)", getPseudoClass(), Integer.valueOf(this.f31373a), Integer.valueOf(this.f31374b));
        }
    }
