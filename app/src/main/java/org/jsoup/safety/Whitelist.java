...
public class Whitelist {
    ...
    public static Whitelist basic() {
        return new Whitelist().addTags("a", "b", "blockquote", "br", "cite", "code", "dd", "dl", "dt", "em", "i", "li", "ol", "p", "pre", "q", "small", "span", "strike", "strong", "sub", "sup", "u", "ul").addAttributes("a", "href").addAttributes("blockquote", "cite").addAttributes("q", "cite").addProtocols("a", "href", "ftp", "http", ClientConstants.DOMAIN_SCHEME, "mailto").addProtocols("blockquote", "cite", "http", ClientConstants.DOMAIN_SCHEME).addProtocols("cite", "cite", "http", ClientConstants.DOMAIN_SCHEME).addEnforcedAttribute("a", "rel", "nofollow");
    }

    public static Whitelist basicWithImages() {
        return basic().addTags("img").addAttributes("img", "align", "alt", "height", "src", ChartFactory.TITLE, "width").addProtocols("img", "src", "http", ClientConstants.DOMAIN_SCHEME);
    }
