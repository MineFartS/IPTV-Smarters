...
public final class MediaBrowserCompat {
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void onConnected() {
            try {
                ...
                IBinder iBinderA = f.a(extras, "extra_messenger");
                if (iBinderA != null) {
                ...
                IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(f.a(extras, "extra_session_binder"));
        ...
        */
        public void unsubscribe(java.lang.String r8, android.support.v4.media.MediaBrowserCompat.SubscriptionCallback r9) {
            /*
                r7 = this;
                a.f.a<java.lang.String, android.support.v4.media.MediaBrowserCompat$Subscription> r0 = r7.mSubscriptions
            ...
            L84:
                ...
                if (r9 != 0) goto L91
            L8c:
                a.f.a<java.lang.String, android.support.v4.media.MediaBrowserCompat$Subscription> r9 = r7.mSubscriptions
                r9.remove(r8)
            L91:
                return
            */
    ...
    public static class ServiceBinderWrapper {
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            f.b(bundle2, "data_callback_token", iBinder);
        ...
        public void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            f.b(bundle, "data_callback_token", iBinder);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i2 = 0; i2 < this.mOptionsList.size(); i2++) {
                if (a.s.a.a(this.mOptionsList.get(i2), bundle)) {
    ...
    public static abstract class SubscriptionCallback {
        ...
        public SubscriptionCallback() {
            ...
            this.mSubscriptionCallbackFwk = i2 >= 26 ? new SubscriptionCallbackApi26() : i2 >= 21 ? new SubscriptionCallbackApi21() : null;
        }
