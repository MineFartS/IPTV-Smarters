...
public final class MediaControllerCompat {
        ...
        */
        public android.os.Bundle getSessionInfo() {
            ...
            L1b:
                ...
                if (r0 == 0) goto L3b
                android.support.v4.media.session.MediaSessionCompat$Token r0 = r3.mSessionToken     // Catch: android.os.RemoteException -> L30
                android.support.v4.media.session.IMediaSession r0 = r0.getExtraBinder()     // Catch: android.os.RemoteException -> L30
                android.os.Bundle r0 = r0.getSessionInfo()     // Catch: android.os.RemoteException -> L30
                r3.mSessionInfo = r0     // Catch: android.os.RemoteException -> L30
                goto L3b
            L30:
                r0 = move-exception
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        Object tag = activity.getWindow().getDecorView().getTag(a.s.f.f3106e);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(a.s.f.f3106e, mediaControllerCompat);
        if (Build.VERSION.SDK_INT >= 21) {
