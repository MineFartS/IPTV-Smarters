...
public class MediaSessionCompat {
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        f.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public int getRccTransportControlFlagsFromActions(long j2) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j2);
            return (j2 & 128) != 0 ? rccTransportControlFlagsFromActions | IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public MediaSessionImplApi21(MediaSession mediaSession, d dVar, Bundle bundle) {
        ...
        public void setPlaybackToRemote(i iVar) {
            this.mSessionFwk.setPlaybackToRemote((VolumeProvider) iVar.d());
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        public MediaSessionImplApi28(MediaSession mediaSession, d dVar, Bundle bundle) {
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(MediaSession mediaSession, d dVar, Bundle bundle) {
            super(mediaSession, dVar, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public int mFlags = 3;
        private i.c mVolumeCallback = new i.c() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // a.s.i.c
  ...
  0x001d: PHI (r2v30 android.graphics.Bitmap) = (r2v3 android.graphics.Bitmap), (r2v33 android.graphics.Bitmap) binds: [B:14:0x0037, B:8:0x001b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(f.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
            d dVarB = a.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.mLock) {
                ...
                if (iMediaSession != null) {
                    f.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                }
                d dVar = this.mSession2Token;
                if (dVar != null) {
                    a.c(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, dVar);
                }
            }
            return bundle;
        }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, d dVar) {
        ...
        if (componentName == null && (componentName = a.s.k.a.a(context)) == null) {
        ...
        if (i2 >= 21) {
            ...
            this.mImpl = i2 >= 29 ? new MediaSessionImplApi29(mediaSessionCreateFwkMediaSession, dVar, bundle) : i2 >= 28 ? new MediaSessionImplApi28(mediaSessionCreateFwkMediaSession, dVar, bundle) : new MediaSessionImplApi21(mediaSessionCreateFwkMediaSession, dVar, bundle);
            ...
            this.mImpl = i2 >= 19 ? new MediaSessionImplApi19(context, str, componentName2, pendingIntent2, dVar, bundle) : i2 >= 18 ? new MediaSessionImplApi18(context, str, componentName2, pendingIntent2, dVar, bundle) : new MediaSessionImplBase(context, str, componentName2, pendingIntent2, dVar, bundle);
        }
        this.mController = new MediaControllerCompat(context, this);
        if (sMaxBitmapSize == 0) {
