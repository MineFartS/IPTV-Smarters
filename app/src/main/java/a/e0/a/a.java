...
public abstract class a {
    ...
    public final DataSetObservable f1243a = new DataSetObservable();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public DataSetObserver f1244b;
    ...
    public void i(DataSetObserver dataSetObserver) {
        this.f1243a.registerObserver(dataSetObserver);
    }
    ...
    public abstract void l(ViewGroup viewGroup, int i2, Object obj);

    public void m(DataSetObserver dataSetObserver) {
        synchronized (this) {
            this.f1244b = dataSetObserver;
        }
    }
    ...
    public void o(DataSetObserver dataSetObserver) {
        this.f1243a.unregisterObserver(dataSetObserver);
    }
}
