...
public final class a0 {
    ...
    public static void c(ViewParent viewParent, View view, int i2, int i3, int[] iArr, int i4) {
        if (viewParent instanceof n) {
            ((n) viewParent).o(view, i2, i3, iArr, i4);
            return;
        }
        if (i4 == 0) {
            if (Build.VERSION.SDK_INT < 21) {
    ...
    public static void d(ViewParent viewParent, View view, int i2, int i3, int i4, int i5, int i6, int[] iArr) {
        if (viewParent instanceof o) {
            ((o) viewParent).j(view, i2, i3, i4, i5, i6, iArr);
            return;
        }
        iArr[0] = iArr[0] + i4;
        iArr[1] = iArr[1] + i5;
        if (viewParent instanceof n) {
            ((n) viewParent).k(view, i2, i3, i4, i5, i6);
            return;
        }
        if (i6 == 0) {
            if (Build.VERSION.SDK_INT < 21) {
                if (viewParent instanceof p) {
                    ((p) viewParent).onNestedScroll(view, i2, i3, i4, i5);
                    return;
                }
                return;
            }
    ...
    public static void e(ViewParent viewParent, View view, View view2, int i2, int i3) {
        if (viewParent instanceof n) {
            ((n) viewParent).m(view, view2, i2, i3);
            return;
        }
        if (i3 == 0) {
            if (Build.VERSION.SDK_INT < 21) {
    ...
    public static boolean f(ViewParent viewParent, View view, View view2, int i2, int i3) {
        if (viewParent instanceof n) {
            return ((n) viewParent).l(view, view2, i2, i3);
        }
        if (i3 != 0) {
            return false;
        }
