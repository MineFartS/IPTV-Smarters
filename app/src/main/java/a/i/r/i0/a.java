...
public final class a {
    ...
    public static final String[] f2076a = new String[0];

    /* JADX INFO: renamed from: a.i.r.i0.a$a, reason: collision with other inner class name */
    ...
    public static String[] a(EditorInfo editorInfo) {
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            return strArr != null ? strArr : f2076a;
        }
        ...
        return stringArray != null ? stringArray : f2076a;
    }
    ...
    public static void e(EditorInfo editorInfo, CharSequence charSequence, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            C0044a.a(editorInfo, charSequence, i2);
            return;
        }
    ...
    public static void f(EditorInfo editorInfo, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 30) {
            C0044a.a(editorInfo, charSequence, 0);
        } else {
