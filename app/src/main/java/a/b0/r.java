...
public class r {
    ...
    public static final boolean f994b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final boolean f995c;
    ...
    */
    public static android.graphics.Bitmap b(android.view.View r9, android.graphics.Matrix r10, android.graphics.RectF r11, android.view.ViewGroup r12) {
        ...
        La7:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: a.b0.r.b(android.view.View, android.graphics.Matrix, android.graphics.RectF, android.view.ViewGroup):android.graphics.Bitmap");
    }
