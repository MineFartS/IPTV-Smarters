...
public class i0 {
    ...
    public static boolean f933b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static Field f934c;
    ...
    public float c(View view) {
        Float f2 = (Float) view.getTag(j.f936a);
    ...
    public void f(View view, float f2) {
        Float f3 = (Float) view.getTag(j.f936a);
        if (f3 != null) {
    ...
    public void g(View view, int i2) {
        ...
        if (field != null) {
            try {
                f934c.setInt(view, i2 | (field.getInt(view) & (-13)));
