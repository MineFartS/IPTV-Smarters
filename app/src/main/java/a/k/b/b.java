...
public class b {
    ...
    /* JADX INFO: renamed from: a.k.b.b$b, reason: collision with other inner class name */
    public interface InterfaceC0051b<T, V> {
        V a(T t, int i2);
    ...
    public static class c<T> implements Comparator<T> {
        ...
        public final Rect f2192b = new Rect();

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public final Rect f2193c = new Rect();

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public final boolean f2194d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        public final a<T> f2195e;
        ...
        public int compare(T t, T t2) {
            Rect rect = this.f2192b;
            Rect rect2 = this.f2193c;
            this.f2195e.a(t, rect);
            this.f2195e.a(t2, rect2);
            int i2 = rect.top;
            int i3 = rect2.top;
            if (i2 < i3) {
                return -1;
    ...
    */
    public static <L, T> T c(L r7, a.k.b.b.InterfaceC0051b<L, T> r8, a.k.b.b.a<T> r9, T r10, android.graphics.Rect r11, int r12) {
        /*
        ...
        L64:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: a.k.b.b.c(java.lang.Object, a.k.b.b$b, a.k.b.b$a, java.lang.Object, android.graphics.Rect, int):java.lang.Object");
    }

    public static <L, T> T d(L l2, InterfaceC0051b<L, T> interfaceC0051b, a<T> aVar, T t, int i2, boolean z, boolean z2) {
        int iB = interfaceC0051b.b(l2);
        ArrayList arrayList = new ArrayList(iB);
        for (int i3 = 0; i3 < iB; i3++) {
            arrayList.add(interfaceC0051b.a(l2, i3));
        }
    ...
    public static boolean h(int i2, Rect rect, Rect rect2, Rect rect3) {
        if (!i(rect, rect2, i2)) {
            return false;
        }
    ...
    public static boolean i(Rect rect, Rect rect2, int i2) {
        if (i2 == 17) {
            int i3 = rect.right;
            int i4 = rect2.right;
