...
public class i {
    ...
    public final Deque<WeakReference<XmlPullParser>> f206a = new ArrayDeque();
    ...
    public boolean a(AttributeSet attributeSet) {
        ...
        XmlPullParser xmlPullParserC = c(this.f206a);
        this.f206a.push(new WeakReference<>(xmlPullParser));
