...
public class b {
    ...
    public static final ThreadLocal<Matrix> f1620a = new ThreadLocal<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ThreadLocal<RectF> f1621b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f1620a;
        ...
        ThreadLocal<RectF> threadLocal2 = f1621b;
