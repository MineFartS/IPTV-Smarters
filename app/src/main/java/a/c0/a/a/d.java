...
public class d {
    ...
    public static class a implements TypeEvaluator<c.b[]> {
        ...
        public c.b[] evaluate(float f2, c.b[] bVarArr, c.b[] bVarArr2) {
            if (!a.i.j.c.b(bVarArr, bVarArr2)) {
                throw new IllegalArgumentException("Can't interpolate between two incompatible pathData");
            }
            if (!a.i.j.c.b(this.f1066a, bVarArr)) {
                this.f1066a = a.i.j.c.f(bVarArr);
            }
            for (int i2 = 0; i2 < bVarArr.length; i2++) {
                this.f1066a[i2].d(bVarArr[i2], bVarArr2[i2], f2);
            }
            return this.f1066a;
        }
    }
    ...
    */
    public static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: a.c0.a.a.d.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    public static PropertyValuesHolder e(TypedArray typedArray, int i2, int i3, int i4, String str) {
        ...
        c.b[] bVarArrD = a.i.j.c.d(string);
        c.b[] bVarArrD2 = a.i.j.c.d(string2);
        ...
        if (bVarArrD2 == null) {
            ...
            if (!a.i.j.c.b(bVarArrD, bVarArrD2)) {
    ...
    public static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray typedArrayS = a.i.i.e.g.s(resources, theme, attributeSet, a.c0.a.a.a.f1050j);
        int i2 = 0;
        TypedValue typedValueT = a.i.i.e.g.t(typedArrayS, xmlPullParser, "value", 0);
    ...
    public static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        TypedArray typedArrayS = a.i.i.e.g.s(resources, theme, attributeSet, a.c0.a.a.a.f1047g);
        TypedArray typedArrayS2 = a.i.i.e.g.s(resources, theme, attributeSet, a.c0.a.a.a.f1051k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, typedArrayS, typedArrayS2, f2, xmlPullParser);
        int iL = a.i.i.e.g.l(typedArrayS, xmlPullParser, "interpolator", 0, 0);
        if (iL > 0) {
            valueAnimator.setInterpolator(c.b(context, iL));
        }
        typedArrayS.recycle();
    ...
    public static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i2, XmlPullParser xmlPullParser) {
        TypedArray typedArrayS = a.i.i.e.g.s(resources, theme, attributeSet, a.c0.a.a.a.f1050j);
        float fJ = a.i.i.e.g.j(typedArrayS, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue typedValueT = a.i.i.e.g.t(typedArrayS, xmlPullParser, "value", 0);
        boolean z = typedValueT != null;
        if (i2 == 4) {
            i2 = (z && h(typedValueT.type)) ? 3 : 0;
        }
        Keyframe keyframeOfInt = z ? i2 != 0 ? (i2 == 1 || i2 == 3) ? Keyframe.ofInt(fJ, a.i.i.e.g.k(typedArrayS, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(fJ, a.i.i.e.g.j(typedArrayS, xmlPullParser, "value", 0, 0.0f)) : i2 == 0 ? Keyframe.ofFloat(fJ) : Keyframe.ofInt(fJ);
        int iL = a.i.i.e.g.l(typedArrayS, xmlPullParser, "interpolator", 1, 0);
        if (iL > 0) {
            keyframeOfInt.setInterpolator(c.b(context, iL));
        }
        typedArrayS.recycle();
        return keyframeOfInt;
    }

    public static ObjectAnimator n(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, float f2, XmlPullParser xmlPullParser) {
    ...
    public static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (eventType == 2 && xmlPullParser.getName().equals("propertyValuesHolder")) {
                TypedArray typedArrayS = a.i.i.e.g.s(resources, theme, attributeSet, a.c0.a.a.a.f1049i);
                String strM = a.i.i.e.g.m(typedArrayS, xmlPullParser, "propertyName", 3);
                int iK = a.i.i.e.g.k(typedArrayS, xmlPullParser, "valueType", 2, 4);
    ...
    public static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long jK = a.i.i.e.g.k(typedArray, xmlPullParser, "duration", 1, IjkMediaCodecInfo.RANK_SECURE);
        long jK2 = a.i.i.e.g.k(typedArray, xmlPullParser, "startOffset", 2, 0);
        int iK = a.i.i.e.g.k(typedArray, xmlPullParser, "valueType", 7, 4);
        if (a.i.i.e.g.r(xmlPullParser, "valueFrom") && a.i.i.e.g.r(xmlPullParser, "valueTo")) {
            if (iK == 4) {
                iK = f(typedArray, 5, 6);
            }
            PropertyValuesHolder propertyValuesHolderE = e(typedArray, iK, 5, 6, BuildConfig.FLAVOR);
        ...
        valueAnimator.setRepeatCount(a.i.i.e.g.k(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(a.i.i.e.g.k(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
            r(valueAnimator, typedArray2, iK, f2, xmlPullParser);
        }
    }

    public static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i2, float f2, XmlPullParser xmlPullParser) {
        ObjectAnimator objectAnimator = (ObjectAnimator) valueAnimator;
        String strM = a.i.i.e.g.m(typedArray, xmlPullParser, "pathData", 1);
        if (strM == null) {
            objectAnimator.setPropertyName(a.i.i.e.g.m(typedArray, xmlPullParser, "propertyName", 0));
            return;
        }
        String strM2 = a.i.i.e.g.m(typedArray, xmlPullParser, "propertyXName", 2);
        String strM3 = a.i.i.e.g.m(typedArray, xmlPullParser, "propertyYName", 3);
        if (i2 != 2) {
        }
        if (strM2 != null || strM3 != null) {
            s(a.i.j.c.e(strM), objectAnimator, f2 * 0.5f, strM2, strM3);
            return;
        }
        throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
    }

    public static void s(Path path, ObjectAnimator objectAnimator, float f2, String str, String str2) {
